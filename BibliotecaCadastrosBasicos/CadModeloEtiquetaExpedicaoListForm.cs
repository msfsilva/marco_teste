...
{
    public partial class CadModeloEtiquetaExpedicaoListForm : IWTListForm
    {

       public CadModeloEtiquetaExpedicaoListForm()
        {
            InitializeComponent();
        }
        ...
        {
            return typeof(ModeloEtiquetaExpedicaoClass);
        }
