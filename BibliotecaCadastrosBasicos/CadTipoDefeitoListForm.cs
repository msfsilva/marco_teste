...
namespace BibliotecaCadastrosBasicos
{
    ...
    public partial class CadTipoDefeitoListForm : IWTListForm
    {
        private IWTDataGridView iwtDataGridView1;
        private IContainer components;
        private DataGridViewTextBoxColumn Identificacao;
        private DataGridViewTextBoxColumn Descricao;
        private IWTSearchPanel iwtSearchPanel1;
        private IWTDefaultListButtons iwtDefaultListButtons1;
        private IWTTextBox iwtTextBox1;
        private IWTLabel iwtLabel1;
        private TipoForm Tipo;

        public CadTipoDefeitoListForm(TipoForm tipo)
        {
            InitializeComponent();
            this.Tipo = tipo;
        }
        ...
        {
            return typeof(TipoDefeitoClass);
        }
        ...
        protected override void chamadaForm(AbstractEntity entidade)
        {
            try
            {
                CadTipoDefeitoForm form = new CadTipoDefeitoForm((TipoDefeitoClass)entidade, this);
        ...
        {
            return new List<SearchParameterClass>() { new SearchParameterClass("tde_identificacao", null, SearchOperacao.SomenteOrdenacao, SearchOrdenacao.Asc, TipoOrdenacao.String) };
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.iwtDataGridView1.TabIndex = 2;
            // 
            // Identificacao
            // 
            ...
            this.iwtTextBox1.Location = new System.Drawing.Point(54, 17);
            ...
            this.iwtTextBox1.Size = new System.Drawing.Size(256, 20);
            ...
            this.iwtLabel1.Location = new System.Drawing.Point(11, 20);
            ...
            // 
            // CadTipoDefeitoListForm
            // 
            this.ClientSize = new System.Drawing.Size(648, 305);
            this.Name = "CadTipoDefeitoListForm";
            this.Text = "Tipos de Defeito";
