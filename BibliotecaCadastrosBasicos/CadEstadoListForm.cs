...
{
    public partial class CadEstadoListForm : IWTListForm
    {

       public CadEstadoListForm()
        {
            InitializeComponent();
        }
        ...
        protected override void chamadaForm(AbstractEntity entidade)
        {
            try
            {
                CadEstadoForm form = new CadEstadoForm((EstadoClass)entidade, this);
