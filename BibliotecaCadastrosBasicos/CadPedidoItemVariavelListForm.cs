...
namespace BibliotecaCadastrosBasicos
{
    ...
    public partial class CadPedidoItemVariavelListForm : IWTBaseForm
    {
        private PedidoItemClass Pedido;

        public CadPedidoItemVariavelListForm(PedidoItemClass pedido)
        {
            InitializeComponent();
            this.Pedido = pedido;
        ...
        private void loadComboVariaveis()
        {
            try
            {
                ...
                {
                    searchParameters.Add(new SearchParameterClass("FamiliaClienteOrNull", this.Pedido.Cliente.FamiliaCliente));
                }
                else
                {
        ...
        private void loadComboSubLinhas()
        {
            try
            {
                ...
                list.Add(new LoadClass("0", this.Pedido.Produto.Codigo));
                foreach (PedidoItemClass pedidoItem in this.Pedido.CollectionPedidoItemClassPedidoItemPai)
                {
        ...
        private void InitializeGridPedido()
        {
            try
            {
                ...
                this.dgvVariaveisPedido.DataSource = null;
                this.dgvVariaveisPedido.DataSource = this.Pedido.CollectionPedidoVariavelClassPedidoItem;
            }
            ...
            {
                throw new ExcecaoTratada("Erro ao inicializar o grid de variáveis do pedido\r\n" + e.Message, e);
            }
        }
        ...
        private void SelecionarLinhaGridPedido()
        {
            ...
            {
                throw new ExcecaoTratada("Erro ao selecionar a linha do grid de variáveis do pedido\r\n" + e.Message, e);
            }
        }
        ...
        private void SalvarVariavelPedido()
        {
            try
            {
                ...
                this.Pedido.AtualizarIncluirVariavel((VariavelClass)this.cmbVariavel.SelectedItem, this.txtValor.Text.Trim());
                this.InitializeGridPedido(); 
            ...
            {
                throw new ExcecaoTratada("Erro ao  atualizar/adicionar a variável no pedido\r\n" + e.Message, e);
            }
        }
        ...
        private void ExcluirVariavelPedido()
        {
            try
            {
                ...
                {
                    PedidoVariavelClass selecionado = (PedidoVariavelClass) row.DataBoundItem;

                    this.Pedido.ExcluirVariavelPedido(selecionado);
                }
                this.InitializeGridPedido();
            }
            catch (ExcecaoTratada e)
            ...
            {
                throw new ExcecaoTratada("Erro ao excluir a variável do pedido\r\n" + e.Message, e);
            }
        }

        #endregion

        #region Variáveis dos Itens Pedido
        ...
        private void InitializeGridItem()
        {
            try
            {
                ...
                this.dgvVariaveisItensPedido.DataSource = null;


                List<PedidoItemVariavelClass> tmp = new List<PedidoItemVariavelClass>(this.Pedido.CollectionPedidoItemVariavelClassPedidoItem);
                foreach (PedidoItemClass item in this.Pedido.CollectionPedidoItemClassPedidoItemPai)
                {
                    tmp.AddRange(item.CollectionPedidoItemVariavelClassPedidoItem);
                }
        ...
        private void SelecionarLinhaGridItemPedido()
        {
            try
            {
                ...
                this.cmbSublinha.SelectedValue = selecionado.PedidoItem.SubLinha.ToString();
            }
            catch (ExcecaoTratada e)
            {
                throw;
            ...
            {
                throw new ExcecaoTratada("Erro ao selecionar a linha do grid de variáveis dos itens do pedido\r\n" + e.Message, e);
            }
        }
        ...
        private void SalvarVariavelItemPedido()
        {
            try
            {
                ...
                this.Pedido.AtualizarIncluirVariavelItem((VariavelClass)this.cmbVariavelItem.SelectedItem, this.txtValorItem.Text.Trim(), int.Parse(this.cmbSublinha.SelectedValue.ToString()));
                InitializeGridItem();
            }
            catch (ExcecaoTratada e)
            {
            ...
            {
                throw new ExcecaoTratada("Erro ao atualizar/adicionar a variável no item do pedido\r\n" + e.Message, e);
            }
        }
        ...
        private void ExcluirVariavelItemPedido()
        {
            try
            {
                ...
                {
                    PedidoItemVariavelClass selecionado = (PedidoItemVariavelClass) row.DataBoundItem;

                    this.Pedido.ExcluirVariavelItemPedido(selecionado);
        ...
        #region Eventos Variáveis do Pedido
        ...
        #region Eventos Variáveis dos Itens Pedido
