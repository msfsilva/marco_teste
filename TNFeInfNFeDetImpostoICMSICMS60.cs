...
namespace IWTNFCompleto.BibliotecaDatasets.v4_0
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("TNFeInfNFeDetImpostoICMSICMS60", Namespace="http://www.portalfiscal.inf.br/nfe", AnonymousType=true)]
    ...
    public partial class TNFeInfNFeDetImpostoICMSICMS60
    {
        ...
        /// <summary>
        /// <para>Valor da BC do ICMS ST retido anteriormente</para>
        ...
        /// </summary>
        [System.ComponentModel.DescriptionAttribute("Valor da BC do ICMS ST retido anteriormente")]
        ...
        /// <summary>
        /// <para>Valor do ICMS ST retido anteriormente</para>
        /// <para>Tipo Decimal com 15 dígitos, sendo 13 de corpo e 2 decimais</para>
        /// <para xml:lang="en">Pattern: 0|0\.[0-9]{2}|[1-9]{1}[0-9]{0,12}(\.[0-9]{2})?.</para>
        /// </summary>
        [System.ComponentModel.DescriptionAttribute("Valor do ICMS ST retido anteriormente")]
        [System.ComponentModel.DataAnnotations.RegularExpressionAttribute("0|0\\.[0-9]{2}|[1-9]{1}[0-9]{0,12}(\\.[0-9]{2})?")]
        [System.Xml.Serialization.XmlElementAttribute("vICMSSTRet")]
        public string vICMSSTRet { get; set; }
        
        /// <summary>
        /// <para>Valor da Base de cálculo do FCP retido anteriormente por ST.</para>
        /// <para>Tipo Decimal com 15 dígitos, sendo 13 de corpo e 2 decimais</para>
        /// <para xml:lang="en">Pattern: 0|0\.[0-9]{2}|[1-9]{1}[0-9]{0,12}(\.[0-9]{2})?.</para>
        /// </summary>
        [System.ComponentModel.DescriptionAttribute("Valor da Base de cálculo do FCP retido anteriormente por ST.")]
        [System.ComponentModel.DataAnnotations.RegularExpressionAttribute("0|0\\.[0-9]{2}|[1-9]{1}[0-9]{0,12}(\\.[0-9]{2})?")]
