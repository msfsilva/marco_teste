...
{ 
 ...
 #region Constantes
protected const string ErroLoad = "Erro ao carregar os dados do BufferEmail2Class";
protected const string ErroDelete = "Erro ao excluir o BufferEmail2Class  ";
protected const string ErroSave = "Erro ao salvar o BufferEmail2Class.";
protected const string ErroCollectionBufferEmailAnexoClassBufferEmail = "Erro ao carregar a coleção de BufferEmailAnexo2Class.";
...
protected const string ErroValidate = "Erro ao validar os dados do BufferEmail2Class.";
protected const string MensagemUtilizadoCollectionBufferEmailAnexoClassBufferEmail =  "A entidade BufferEmail2Class está sendo utilizada nos seguintes BufferEmailAnexo2Class:";
protected const string ErroUtilizado =  "Erro ao verificar se a entidade BufferEmail2Class está sendo utilizada.";
#endregion
       ...
       protected short _corpoHtmlOriginal{get;private set;}
       private short _corpoHtmlOriginalCommited{get; set;}
        private short _valueCorpoHtml;
         [Column("buf_corpo_html")]
        public virtual short CorpoHtml
         { 
       ...
       private BufferEmailSituacao _situacaoOriginalCommited{get; set;}
        ...
        public bool Situacao_Pendente
         { 
            get { return this._valueSituacao == IWTNFCompleto.BibliotecaEntidades.Base.BufferEmailSituacao.Pendente; } 
            set { if (value) this._valueSituacao = IWTNFCompleto.BibliotecaEntidades.Base.BufferEmailSituacao.Pendente; }
         } 

        public bool Situacao_Enviado
         { 
            get { return this._valueSituacao == IWTNFCompleto.BibliotecaEntidades.Base.BufferEmailSituacao.Enviado; } 
            set { if (value) this._valueSituacao = IWTNFCompleto.BibliotecaEntidades.Base.BufferEmailSituacao.Enviado; }
         } 

        public bool Situacao_Erro
         { 
            get { return this._valueSituacao == IWTNFCompleto.BibliotecaEntidades.Base.BufferEmailSituacao.Erro; } 
            set { if (value) this._valueSituacao = IWTNFCompleto.BibliotecaEntidades.Base.BufferEmailSituacao.Erro; }
         } 

       private List<long> _collectionBufferEmailAnexoClassBufferEmailOriginal;
       private List<BufferEmailAnexo2Class > _collectionBufferEmailAnexoClassBufferEmailRemovidos;
       ...
       protected BindingList<BufferEmailAnexo2Class> _valueCollectionBufferEmailAnexoClassBufferEmail { get; set;} 
       [UnCloneable(UnCloneableAttributeType.RetPadrao)] 
       public BindingList<BufferEmailAnexo2Class> CollectionBufferEmailAnexoClassBufferEmail 
       { 
...
public static BufferEmail2Class GetEntidade(long id, AcsUsuarioClass usuarioAtual, IWTPostgreNpgsqlConnection connection, Guid? operacao = null)
        {
            return (BufferEmail2Class) GetEntity(typeof(BufferEmail2Class),id,usuarioAtual,connection, operacao);
        }
        private void CollectionBufferEmailAnexoClassBufferEmailChangedEvent(object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
           ...
           { 
             ...
             case NotifyCollectionChangedAction.Move: 
                  _valueCollectionBufferEmailAnexoClassBufferEmailChanged = true; 
                  _valueCollectionBufferEmailAnexoClassBufferEmailCommitedChanged = true;
                 foreach (BufferEmailAnexo2Class item in e.OldItems) 
                 { 
             ...
             case NotifyCollectionChangedAction.Reset: 
                  _valueCollectionBufferEmailAnexoClassBufferEmailChanged = true; 
                  _valueCollectionBufferEmailAnexoClassBufferEmailCommitedChanged = true;
                 foreach (BufferEmailAnexo2Class item in _valueCollectionBufferEmailAnexoClassBufferEmail) 
                 { 
                     _collectionBufferEmailAnexoClassBufferEmailRemovidos.Add(item); 
                 } 
                 break; 
         ...
         protected void LoadCollectionBufferEmailAnexoClassBufferEmail()
         {
            try
            {
                 ObservableCollection<BufferEmailAnexo2Class> oc;
                ...
                _collectionBufferEmailAnexoClassBufferEmailRemovidos = new List<BufferEmailAnexo2Class>();
                if (this.ID == -1) 
                {
                     oc = new ObservableCollection<BufferEmailAnexo2Class>();
                }
                else{ 
                   BufferEmailAnexo2Class search = new BufferEmailAnexo2Class(this.UsuarioAtual, SingleConnection);
                   search.BufferSecundario = this.BufferSecundario; 
                    oc = 
                      new ObservableCollection<BufferEmailAnexo2Class>(                        search.Search(new List<SearchParameterClass>() {                            new SearchParameterClass("BufferEmail2", this),                     }                       ).Cast<BufferEmailAnexo2Class>().ToList());
                 }
                 _valueCollectionBufferEmailAnexoClassBufferEmail = new BindingList<BufferEmailAnexo2Class>(oc); 
 ...
 if (CollectionBufferEmailAnexoClassBufferEmail.Count > 0) 
            {
                ...
                foreach (BufferEmailAnexo2Class tmp in CollectionBufferEmailAnexoClassBufferEmail)
                {
       ...
       public override string ToString()
        ...
        public static BufferEmail2Class CopiarEntidade(BufferEmail2Class entidadeCopiar, AcsUsuarioClass usuario, IWTPostgreNpgsqlConnection conn)
        {
            try
            {
               BufferEmail2Class toRet = new BufferEmail2Class(usuario,conn);
        ...
        protected override void RollbackChangesEntidade()
        {
            ...
            try
            {
               ...
               if (_valueCollectionBufferEmailAnexoClassBufferEmailLoaded) 
               {
                  ...
                  {
                    CollectionBufferEmailAnexoClassBufferEmail.Add(BufferEmailAnexo2Class.GetEntidade(item, UsuarioAtual, SingleConnection));
                  }
                  _collectionBufferEmailAnexoClassBufferEmailRemovidos.Clear();
               }
       ...
       dirty = _situacaoOriginalCommited != Situacao;
        ...
        protected override void SaveCollections(ref IWTPostgreNpgsqlCommand command)
        {
            ...
            try
            {
               if (_valueCollectionBufferEmailAnexoClassBufferEmailLoaded) 
               {
                  foreach(BufferEmailAnexo2Class item in CollectionBufferEmailAnexoClassBufferEmail)
                  {
        ...
        protected override List<AbstractEntity> NewSearch(List<SearchParameterClass> parametros, bool somenteCount,out int qtdRegistros, bool utilizarOr = false, int? offset = null, int? limit = null, bool utilizarBuffer = true, Guid? operacao = null)
        {
            ...
            try
            {
               ...
               foreach (SearchParameterClass parametro in parametros) 
               {
                  ...
                  else
                  {
                     ...
                     if (parametro.FieldName == "ID" || parametro.FieldName == "id_buffer_email")
                     {
                      ...
                      {
                         whereClause += "  buffer_email.id_buffer_email = :buffer_email_ID_2945 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("buffer_email_ID_2945", NpgsqlDbType.Bigint, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Remetente" || parametro.FieldName == "buf_remetente")
                     {
                      ...
                      {
                         whereClause += "  buffer_email.buf_remetente LIKE :buffer_email_Remetente_2733 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("buffer_email_Remetente_2733", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Destinatario" || parametro.FieldName == "buf_destinatario")
                     {
                      ...
                      {
                         whereClause += "  buffer_email.buf_destinatario LIKE :buffer_email_Destinatario_3807 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("buffer_email_Destinatario_3807", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Titulo" || parametro.FieldName == "buf_titulo")
                     {
                      ...
                      {
                         whereClause += "  buffer_email.buf_titulo LIKE :buffer_email_Titulo_1696 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("buffer_email_Titulo_1696", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "CorpoMensagem" || parametro.FieldName == "buf_corpo_mensagem")
                     {
                      ...
                      {
                         whereClause += "  buffer_email.buf_corpo_mensagem LIKE :buffer_email_CorpoMensagem_1344 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("buffer_email_CorpoMensagem_1344", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "DataEntrada" || parametro.FieldName == "buf_data_entrada")
                     {
                      ...
                      {
                         whereClause += "  buffer_email.buf_data_entrada = :buffer_email_DataEntrada_5590 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("buffer_email_DataEntrada_5590", NpgsqlDbType.Timestamp, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "DataEnvio" || parametro.FieldName == "buf_data_envio")
                     {
                      ...
                      {
                         whereClause += "  buffer_email.buf_data_envio = :buffer_email_DataEnvio_7459 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("buffer_email_DataEnvio_7459", NpgsqlDbType.Timestamp, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "EntityUid" || parametro.FieldName == "entity_uid")
                     {
                      ...
                      {
                         whereClause += "  buffer_email.entity_uid LIKE :buffer_email_EntityUid_3383 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("buffer_email_EntityUid_3383", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Version" || parametro.FieldName == "version")
                     {
                      ...
                      {
                         whereClause += "  buffer_email.version = :buffer_email_Version_6975 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("buffer_email_Version_6975", NpgsqlDbType.Integer, Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "CorpoHtml" || parametro.FieldName == "buf_corpo_html")
                     {
                      ...
                      {
                         whereClause += "  buffer_email.buf_corpo_html = :buffer_email_CorpoHtml_6687 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("buffer_email_CorpoHtml_6687", NpgsqlDbType.Smallint, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "DataUltimaTentativa" || parametro.FieldName == "buf_data_ultima_tentativa")
                     {
                      ...
                      {
                         whereClause += "  buffer_email.buf_data_ultima_tentativa = :buffer_email_DataUltimaTentativa_359 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("buffer_email_DataUltimaTentativa_359", NpgsqlDbType.Timestamp, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "UltimoErro" || parametro.FieldName == "buf_ultimo_erro")
                     {
                      ...
                      {
                         whereClause += "  buffer_email.buf_ultimo_erro LIKE :buffer_email_UltimoErro_777 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("buffer_email_UltimoErro_777", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "NumeroTentativasEnvio" || parametro.FieldName == "buf_numero_tentativas_envio")
                     {
                      ...
                      {
                         whereClause += "  buffer_email.buf_numero_tentativas_envio = :buffer_email_NumeroTentativasEnvio_2110 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("buffer_email_NumeroTentativasEnvio_2110", NpgsqlDbType.Smallint, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Situacao" || parametro.FieldName == "buf_situacao")
                     {
                      ...
                      {
                         whereClause += "  buffer_email.buf_situacao = :buffer_email_Situacao_1583 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("buffer_email_Situacao_1583", NpgsqlDbType.Smallint,  Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "RemetenteExato" || parametro.FieldName == "RemetenteExata")
                     {
                      ...
                      {
                         whereClause += "  buffer_email.buf_remetente LIKE :buffer_email_Remetente_4999 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("buffer_email_Remetente_4999", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "DestinatarioExato" || parametro.FieldName == "DestinatarioExata")
                     {
                      ...
                      {
                         whereClause += "  buffer_email.buf_destinatario LIKE :buffer_email_Destinatario_9810 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("buffer_email_Destinatario_9810", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "TituloExato" || parametro.FieldName == "TituloExata")
                     {
                      ...
                      {
                         whereClause += "  buffer_email.buf_titulo LIKE :buffer_email_Titulo_9903 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("buffer_email_Titulo_9903", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "CorpoMensagemExato" || parametro.FieldName == "CorpoMensagemExata")
                     {
                      ...
                      {
                         whereClause += "  buffer_email.buf_corpo_mensagem LIKE :buffer_email_CorpoMensagem_6566 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("buffer_email_CorpoMensagem_6566", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "EntityUidExato" || parametro.FieldName == "EntityUidExata")
                     {
                      ...
                      {
                         whereClause += "  buffer_email.entity_uid LIKE :buffer_email_EntityUid_4002 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("buffer_email_EntityUid_4002", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "UltimoErroExato" || parametro.FieldName == "UltimoErroExata")
                     {
                      ...
                      {
                         whereClause += "  buffer_email.buf_ultimo_erro LIKE :buffer_email_UltimoErro_3643 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("buffer_email_UltimoErro_3643", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
               ...
               while (read.Read())
               {
                  ...
                  qtdRegistros++;
                  BufferEmail2Class entidade = null;
if (!operacao.HasValue)
{
    operacao = Guid.NewGuid();
                  ...
                  if (utilizarBuffer) 
                  {
                     entidade = (BufferEmail2Class)BufferAbstractEntity.GetEntidadeSemCarregamento(typeof(BufferEmail2Class), Convert.ToInt32(read["id_buffer_email"]), UsuarioAtual, command.Connection, this.BufferSecundario, operacao.Value);
                  }
                  if (entidade == null)
                  {
                     entidade = new BufferEmail2Class(UsuarioAtual, SingleConnection);
                     ...
                     entidade.CorpoHtml = (short)read["buf_corpo_html"];
                     ...
                     entidade = (BufferEmail2Class) BufferAbstractEntity.SetEntidadeBuffer(entidade); 
                  }
                  toRet.Add(entidade);
