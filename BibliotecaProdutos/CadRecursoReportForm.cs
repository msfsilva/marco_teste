...
{
    public partial class CadRecursoReportForm : Form
    {
        private readonly List<int> _idsRecursos;
        private readonly AcsUsuario _user;

        public CadRecursoReportForm(List<int> idsRecursos, AcsUsuario user)
        {
        ...
        private void initReport()
        {
            try
            {
                ...
                while (read.Read())
                {
                    ...
                    row.usuario = this._user.acsLogin;
                ...
                string printer = Configurations.IWTConfiguration.Conf.getConf(Constants.INTERNAL_LABEL_PRINTER);
                string paper = Configurations.IWTConfiguration.Conf.getConf(Constants.INTERNAL_LABEL_PAPER);
