...
namespace BibliotecaCompras
{
    public class OcReportClass
    {
        ...
        public string DescricaoFormaPagto { get; private set; }

        public bool AguardandoAprovacao { get; set; }


        public OcReportClass(
            ...
            )
        {
            ...
            this.Rodape = rodape;
            this.Observacao = obs;
            this.DescricaoFormaPagto = descFormaPagto;
