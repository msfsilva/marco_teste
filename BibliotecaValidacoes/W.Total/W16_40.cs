...
{
    public class W16_40:IValidacao
    {
        public bool Validar(TNFe nfe, out string error)
        {
            if (nfe.infNFe.ide.mod == TMod.Item65)
            {
                ...
                if (valorTotalNfe > 100000 && (nfe.infNFe.dest == null || nfe.infNFe.dest.Item == null))
                {
                    error = "Total da NFC-e superior ao limite permitido para destinatário não identificado";
                    return false;
                }
            }
