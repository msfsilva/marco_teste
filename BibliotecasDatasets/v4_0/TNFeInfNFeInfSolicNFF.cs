...
namespace IWTNFCompleto.BibliotecaDatasets.v4_0
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("TNFeInfNFeInfSolicNFF", Namespace="http://www.portalfiscal.inf.br/nfe", AnonymousType=true)]
    ...
    public partial class TNFeInfNFeInfSolicNFF
    {
        ...
        /// <summary>
        /// <para>Solicitação do pedido de emissão da NFF</para>
        ...
        /// </summary>
        [System.ComponentModel.DescriptionAttribute("Solicitação do pedido de emissão da NFF")]
        ...
        [System.Xml.Serialization.XmlElementAttribute("xSolic", Order=0)]
