...
namespace IWTNFCompleto.BibliotecaDatasets.v4_0
{
    ...
    public partial class TNFeInfNFeDetProd
    {
        ...
        /// <summary>
        /// <para>Classificação para subapuração do IBS na ZFM</para>
        /// </summary>
        [System.ComponentModel.DescriptionAttribute("Classificação para subapuração do IBS na ZFM")]
        [System.Xml.Serialization.XmlElementAttribute("tpCredPresIBSZFM", Order=11)]
        public IWTNFCompleto.BibliotecaDatasets.v4_0.TTpCredPresIBSZFM TpCredPresIBSZFM { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the TpCredPresIBSZFM property is specified.</para>
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public bool TpCredPresIBSZFMSpecified { get; set; }
        ...
        [System.Xml.Serialization.XmlElementAttribute("EXTIPI", Order=12)]
        ...
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("CFOP", Order=13)]
        ...
        [System.ComponentModel.DataAnnotations.RegularExpressionAttribute("[!-ÿ]{1}[ -ÿ]{0,}[!-ÿ]{1}|[!-ÿ]{1}")]
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=false)]
        [System.Xml.Serialization.XmlElementAttribute("uCom", Order=14)]
        ...
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("qCom", Order=15)]
        ...
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("vUnCom", Order=16)]
        ...
        [System.ComponentModel.DataAnnotations.RegularExpressionAttribute("SEM GTIN|[0-9]{0}|[0-9]{8}|[0-9]{12,14}")]
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("cEANTrib", Order=18)]
        ...
        [System.ComponentModel.DataAnnotations.MaxLengthAttribute(30)]
        [System.ComponentModel.DataAnnotations.RegularExpressionAttribute("[!-ÿ]{1}[ -ÿ]{0,}[!-ÿ]{1}|[!-ÿ]{1}")]
        [System.Xml.Serialization.XmlElementAttribute("cBarraTrib", Order=19)]
        ...
        [System.ComponentModel.DataAnnotations.RegularExpressionAttribute("[!-ÿ]{1}[ -ÿ]{0,}[!-ÿ]{1}|[!-ÿ]{1}")]
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=false)]
        [System.Xml.Serialization.XmlElementAttribute("uTrib", Order=20)]
        ...
        [System.ComponentModel.DataAnnotations.RegularExpressionAttribute("0|0\\.[0-9]{1,4}|[1-9]{1}[0-9]{0,10}|[1-9]{1}[0-9]{0,10}(\\.[0-9]{1,4})?")]
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("qTrib", Order=21)]
        ...
        /// <para xml:lang="en">Pattern: 0|0\.[0-9]{1,10}|[1-9]{1}[0-9]{0,10}|[1-9]{1}[0-9]{0,10}(\.[0-9]{1,10})?.</para>
        /// </summary>
        [System.ComponentModel.DescriptionAttribute("Valor unitário de tributação - alterado para aceitar 0 a 10 casas decimais e 11 i" +
            "nteiros")]
        [System.ComponentModel.DataAnnotations.RegularExpressionAttribute("0|0\\.[0-9]{1,10}|[1-9]{1}[0-9]{0,10}|[1-9]{1}[0-9]{0,10}(\\.[0-9]{1,10})?")]
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("vUnTrib", Order=22)]
        ...
        [System.Xml.Serialization.XmlElementAttribute("vFrete", Order=23)]
        ...
        [System.ComponentModel.DataAnnotations.RegularExpressionAttribute("0\\.[0-9]{1}[1-9]{1}|0\\.[1-9]{1}[0-9]{1}|[1-9]{1}[0-9]{0,12}(\\.[0-9]{2})?")]
        [System.Xml.Serialization.XmlElementAttribute("vSeg", Order=24)]
        ...
        [System.ComponentModel.DataAnnotations.RegularExpressionAttribute("0\\.[0-9]{1}[1-9]{1}|0\\.[1-9]{1}[0-9]{1}|[1-9]{1}[0-9]{0,12}(\\.[0-9]{2})?")]
        [System.Xml.Serialization.XmlElementAttribute("vDesc", Order=25)]
        ...
        [System.ComponentModel.DescriptionAttribute("Este campo deverá ser preenchido com: 0 – o valor do item (vProd) não compõe o va" +
            ...
            "-e (vProd)")]
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("indTot", Order=27)]
        public TNFeInfNFeDetProdIndTot indTot { get; set; }
        
        /// <summary>
        /// <para>Indicador de fornecimento de bem móvel usado: 1-Bem Móvel Usado</para>
        /// </summary>
        [System.ComponentModel.DescriptionAttribute("Indicador de fornecimento de bem móvel usado: 1-Bem Móvel Usado")]
        [System.Xml.Serialization.XmlElementAttribute("indBemMovelUsado", Order=28)]
        public TNFeInfNFeDetProdIndBemMovelUsado IndBemMovelUsado { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the IndBemMovelUsado property is specified.</para>
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public bool IndBemMovelUsadoSpecified { get; set; }
        
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        private System.Collections.ObjectModel.Collection<TNFeInfNFeDetProdDI> _dI;
        
        /// <summary>
        /// <para>Declaração de Importação (NT 2011/004)</para>
        /// </summary>
        [System.ComponentModel.DescriptionAttribute("Declaração de Importação (NT 2011/004)")]
        [System.Xml.Serialization.XmlElementAttribute("DI", Order=29)]
        ...
        [System.Xml.Serialization.XmlElementAttribute("detExport", Order=30)]
        ...
        [System.ComponentModel.DataAnnotations.RegularExpressionAttribute("[!-ÿ]{1}[ -ÿ]{0,}[!-ÿ]{1}|[!-ÿ]{1}")]
        [System.Xml.Serialization.XmlElementAttribute("xPed", Order=31)]
        ...
        [System.Xml.Serialization.XmlElementAttribute("nItemPed", Order=32)]
        ...
        [System.Xml.Serialization.XmlElementAttribute("nFCI", Order=33)]
        public string NFCI { get; set; }
        
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        private System.Collections.ObjectModel.Collection<TNFeInfNFeDetProdRastro> _rastro;
        
        [System.Xml.Serialization.XmlElementAttribute("rastro", Order=34)]
        ...
        [System.Xml.Serialization.XmlElementAttribute("infProdNFF", Order=35)]
        ...
        /// </summary>
        [System.ComponentModel.DescriptionAttribute("Informações mais detalhadas do produto (usada na NFF)")]
        [System.Xml.Serialization.XmlElementAttribute("infProdEmb", Order=36)]
        ...
        [System.Xml.Serialization.XmlElementAttribute("veicProd", Order=37)]
        ...
        [System.Xml.Serialization.XmlElementAttribute("med", Order=38)]
        ...
        [System.Xml.Serialization.XmlElementAttribute("arma", Order=39)]
        ...
        [System.Xml.Serialization.XmlElementAttribute("comb", Order=40)]
        ...
        [System.Xml.Serialization.XmlElementAttribute("nRECOPI", Order=41)]
