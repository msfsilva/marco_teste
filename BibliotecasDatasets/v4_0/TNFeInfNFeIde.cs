...
namespace IWTNFCompleto.BibliotecaDatasets.v4_0
{
    ...
    public partial class TNFeInfNFeIde
    {
        ...
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("cNF", Order=1)]
        ...
        [System.Xml.Serialization.XmlElementAttribute("natOp", Order=2)]
        ...
        [System.ComponentModel.DataAnnotations.RegularExpressionAttribute("(((20(([02468][048])|([13579][26]))-02-29))|(20[0-9][0-9])-((((0[1-9])|(1[0-2]))-" +
            ...
            "):00))")]
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("dhEmi", Order=6)]
        ...
        [System.ComponentModel.DataAnnotations.RegularExpressionAttribute("(((20(([02468][048])|([13579][26]))-02-29))|(20[0-9][0-9])-((((0[1-9])|(1[0-2]))-" +
            ...
            "|30)))))T(20|21|22|23|[0-1]\\d):[0-5]\\d:[0-5]\\d([\\-,\\+](0[0-9]|10|11):00|([\\+](12" +
            "):00))")]
        [System.Xml.Serialization.XmlElementAttribute("dhSaiEnt", Order=7)]
        public string dhSaiEnt { get; set; }
        
        /// <summary>
        /// <para>Data da previsão de entrega ou disponibilização do bem (AAAA-MM-DD)</para>
        ...
        /// </summary>
        [System.ComponentModel.DescriptionAttribute("Data da previsão de entrega ou disponibilização do bem (AAAA-MM-DD)")]
        [System.ComponentModel.DataAnnotations.RegularExpressionAttribute("(((20(([02468][048])|([13579][26]))-02-29))|(20[0-9][0-9])-((((0[1-9])|(1[0-2]))-" +
            "((0[1-9])|(1\\d)|(2[0-8])))|((((0[13578])|(1[02]))-31)|(((0[1,3-9])|(1[0-2]))-(29" +
            "|30)))))")]
        [System.Xml.Serialization.XmlElementAttribute("dPrevEntrega", Order=8)]
        ...
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("tpNF", Order=9)]
        ...
        [System.ComponentModel.DescriptionAttribute("Identificador de Local de destino da operação (1-Interna;2-Interestadual;3-Exteri" +
            "or)")]
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("idDest", Order=10)]
        ...
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("cMunFG", Order=11)]
        public string cMunFG { get; set; }
        
        /// <summary>
        /// <para>Informar o município de ocorrência do fato gerador do fato gerador do IBS / CBS.
        ///Campo preenchido somente quando “indPres = 5 (Operação presencial, fora do estabelecimento) ”, e não tiver endereço do destinatário (Grupo: E05) ou local de entrega (Grupo: G01).</para>
        /// <para>Tipo Código do Município da tabela do IBGE</para>
        /// <para xml:lang="en">Pattern: [0-9]{7}.</para>
        /// </summary>
        [System.ComponentModel.DescriptionAttribute(@"Informar o município de ocorrência do fato gerador do fato gerador do IBS / CBS. Campo preenchido somente quando “indPres = 5 (Operação presencial, fora do estabelecimento) ”, e não tiver endereço do destinatário (Grupo: E05) ou local de entrega (Grupo: G01).")]
        [System.ComponentModel.DataAnnotations.RegularExpressionAttribute("[0-9]{7}")]
        [System.Xml.Serialization.XmlElementAttribute("cMunFGIBS", Order=12)]
        ...
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("tpImp", Order=13)]
        ...
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("tpEmis", Order=14)]
        ...
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("cDV", Order=15)]
        ...
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("tpAmb", Order=16)]
        ...
        ///4 - Devolução/Retorno
        ///5 - Nota de crédito
        ///6 - Nota de débito</para>
        /// </summary>
        [System.ComponentModel.DescriptionAttribute("Finalidade da emissão da NF-e: 1 - NFe normal 2 - NFe complementar 3 - NFe de aju" +
            "ste 4 - Devolução/Retorno 5 - Nota de crédito 6 - Nota de débito")]
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("finNFe", Order=17)]
        public TFinNFe finNFe { get; set; }
        
        /// <summary>
        /// <para>Tipo de Nota de Débito</para>
        /// </summary>
        [System.ComponentModel.DescriptionAttribute("Tipo de Nota de Débito")]
        [System.Xml.Serialization.XmlElementAttribute("tpNFDebito", Order=18)]
        public TTpNFDebito TpNFDebito { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the TpNFDebito property is specified.</para>
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public bool TpNFDebitoSpecified { get; set; }
        
        /// <summary>
        /// <para>Tipo de Nota de Crédito</para>
        /// </summary>
        [System.ComponentModel.DescriptionAttribute("Tipo de Nota de Crédito")]
        [System.Xml.Serialization.XmlElementAttribute("tpNFCredito", Order=19)]
        public TTpNFCredito TpNFCredito { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the TpNFCredito property is specified.</para>
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public bool TpNFCreditoSpecified { get; set; }
        ...
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("indFinal", Order=20)]
        ...
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("indPres", Order=21)]
        ...
        [System.ComponentModel.DescriptionAttribute("Indicador de intermediador/marketplace 0=Operação sem intermediador (em site ou p" +
            ...
            "s/marketplace)")]
        [System.Xml.Serialization.XmlElementAttribute("indIntermed", Order=22)]
        ...
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("procEmi", Order=23)]
        ...
        [System.ComponentModel.DataAnnotations.RegularExpressionAttribute("[!-ÿ]{1}[ -ÿ]{0,}[!-ÿ]{1}|[!-ÿ]{1}")]
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=false)]
        [System.Xml.Serialization.XmlElementAttribute("verProc", Order=24)]
        ...
        [System.ComponentModel.DataAnnotations.RegularExpressionAttribute("(((20(([02468][048])|([13579][26]))-02-29))|(20[0-9][0-9])-((((0[1-9])|(1[0-2]))-" +
            ...
            "|30)))))T(20|21|22|23|[0-1]\\d):[0-5]\\d:[0-5]\\d([\\-,\\+](0[0-9]|10|11):00|([\\+](12" +
            "):00))")]
        [System.Xml.Serialization.XmlElementAttribute("dhCont", Order=25)]
        ...
        [System.ComponentModel.DataAnnotations.RegularExpressionAttribute("[!-ÿ]{1}[ -ÿ]{0,}[!-ÿ]{1}|[!-ÿ]{1}")]
        [System.Xml.Serialization.XmlElementAttribute("xJust", Order=26)]
        ...
        [System.Xml.Serialization.XmlElementAttribute("NFref", Order=27)]
        ...
        public TNFeInfNFeIde()
        {
            ...
            this._gPagAntecipado = new System.Collections.ObjectModel.Collection<string>();
        }
        
        /// <summary>
        /// <para>Grupo de Compras Governamentais</para>
        /// </summary>
        [System.ComponentModel.DescriptionAttribute("Grupo de Compras Governamentais")]
        [System.Xml.Serialization.XmlElementAttribute("gCompraGov", Order=28)]
        public IWTNFCompleto.BibliotecaDatasets.v4_0.TCompraGov GCompraGov { get; set; }
        
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        private System.Collections.ObjectModel.Collection<string> _gPagAntecipado;
        
        /// <summary>
        /// <para>Informado para abater as parcelas de antecipação de pagamento, conforme Art. 10. § 4º</para>
        /// </summary>
        [System.ComponentModel.DescriptionAttribute("Informado para abater as parcelas de antecipação de pagamento, conforme Art. 10. " +
            "§ 4º")]
        [System.Xml.Serialization.XmlArrayAttribute("gPagAntecipado", Order=29)]
        [System.Xml.Serialization.XmlArrayItemAttribute("refNFe", Namespace="http://www.portalfiscal.inf.br/nfe")]
        public System.Collections.ObjectModel.Collection<string> GPagAntecipado
        {
            get
            {
                return _gPagAntecipado;
            }
            set
            {
                _gPagAntecipado = value;
            }
        }
        
        /// <summary>
        /// <para xml:lang="en">Gets a value indicating whether the GPagAntecipado collection is empty.</para>
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public bool GPagAntecipadoSpecified
        {
            get
            {
                return ((this.GPagAntecipado != null) 
                            && (this.GPagAntecipado.Count != 0));
            }
        }
    }
}
