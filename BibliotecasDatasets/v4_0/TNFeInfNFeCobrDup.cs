...
namespace IWTNFCompleto.BibliotecaDatasets.v4_0
{
    ...
    public partial class TNFeInfNFeCobrDup
    {
        ...
        [System.Xml.Serialization.XmlElementAttribute("nDup", Order=0)]
        ...
        [System.ComponentModel.DataAnnotations.RegularExpressionAttribute("(((20(([02468][048])|([13579][26]))-02-29))|(20[0-9][0-9])-((((0[1-9])|(1[0-2]))-" +
            ...
            "|30)))))")]
        [System.Xml.Serialization.XmlElementAttribute("dVenc", Order=1)]
        ...
        [System.Xml.Serialization.XmlElementAttribute("vDup", Order=2)]
