...
namespace IWTNFCompleto.BibliotecaDatasets.v4_0
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("TNFeInfNFeDetImpostoICMSICMS02", Namespace="http://www.portalfiscal.inf.br/nfe", AnonymousType=true)]
    ...
    public partial class TNFeInfNFeDetImpostoICMSICMS02
    {
        ...
        ///02= Tributação monofásica própria sobre combustíveis;</para>
        /// </summary>
        [System.ComponentModel.DescriptionAttribute("Tributção pelo ICMS 02= Tributação monofásica própria sobre combustíveis;")]
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("CST", Order=1)]
        public TNFeInfNFeDetImpostoICMSICMS02CST CST { get; set; }
        ...
        /// <summary>
        /// <para>Valor do ICMS própri</para>
        ...
        /// </summary>
        [System.ComponentModel.DescriptionAttribute("Valor do ICMS própri")]
