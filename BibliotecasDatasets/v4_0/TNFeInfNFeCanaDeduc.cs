...
namespace IWTNFCompleto.BibliotecaDatasets.v4_0
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute("TNFeInfNFeCanaDeduc", Namespace="http://www.portalfiscal.inf.br/nfe", AnonymousType=true)]
    ...
    public partial class TNFeInfNFeCanaDeduc
    {
        ...
        /// <summary>
        /// <para>Descrição da Dedução</para>
        /// <para xml:lang="en">Minimum length: 1.</para>
        /// <para xml:lang="en">Maximum length: 60.</para>
        /// <para xml:lang="en">Pattern: [!-ÿ]{1}[ -ÿ]{0,}[!-ÿ]{1}|[!-ÿ]{1}.</para>
        /// </summary>
        [System.ComponentModel.DescriptionAttribute("Descrição da Dedução")]
        ...
        [System.Xml.Serialization.XmlElementAttribute("xDed", Order=0)]
        public string xDed { get; set; }
        
        /// <summary>
        /// <para>valor da dedução</para>
        ...
        /// </summary>
        [System.ComponentModel.DescriptionAttribute("valor da dedução")]
        [System.ComponentModel.DataAnnotations.RegularExpressionAttribute("0|0\\.[0-9]{2}|[1-9]{1}[0-9]{0,12}(\\.[0-9]{2})?")]
        [System.ComponentModel.DataAnnotations.RequiredAttribute(AllowEmptyStrings=true)]
        [System.Xml.Serialization.XmlElementAttribute("vDed", Order=1)]
