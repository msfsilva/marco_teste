               ...
               foreach (SearchParameterClass parametro in parametros) 
               {
                  ...
                  else
                  {
                     ...
                     if (parametro.FieldName == "ID" || parametro.FieldName == "id_nf_notas_relacionadas")
                     {
                      ...
                      {
                         whereClause += "  nf_notas_relacionadas.id_nf_notas_relacionadas = :nf_notas_relacionadas_ID_6727 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_notas_relacionadas_ID_6727", NpgsqlDbType.Bigint, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "NfPrincipal" || parametro.FieldName == "id_nf_principal")
                     {
                      ...
                      {
                         whereClause += "  nf_notas_relacionadas.id_nf_principal = :nf_notas_relacionadas_NfPrincipal_8208 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_notas_relacionadas_NfPrincipal_8208", NpgsqlDbType.Integer, ((AbstractEntity)parametro.Fieldvalue).ID));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Chave" || parametro.FieldName == "nfn_chave")
                     {
                      ...
                      {
                         whereClause += "  nf_notas_relacionadas.nfn_chave LIKE :nf_notas_relacionadas_Chave_2715 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_notas_relacionadas_Chave_2715", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Version" || parametro.FieldName == "version")
                     {
                      ...
                      {
                         whereClause += "  nf_notas_relacionadas.version = :nf_notas_relacionadas_Version_2348 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_notas_relacionadas_Version_2348", NpgsqlDbType.Integer, Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "EntityUid" || parametro.FieldName == "entity_uid")
                     {
                      ...
                      {
                         whereClause += "  nf_notas_relacionadas.entity_uid LIKE :nf_notas_relacionadas_EntityUid_660 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_notas_relacionadas_EntityUid_660", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "ChaveExato" || parametro.FieldName == "ChaveExata")
                     {
                      ...
                      {
                         whereClause += "  nf_notas_relacionadas.nfn_chave LIKE :nf_notas_relacionadas_Chave_3627 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_notas_relacionadas_Chave_3627", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "EntityUidExato" || parametro.FieldName == "EntityUidExata")
                     {
                      ...
                      {
                         whereClause += "  nf_notas_relacionadas.entity_uid LIKE :nf_notas_relacionadas_EntityUid_8797 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_notas_relacionadas_EntityUid_8797", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
