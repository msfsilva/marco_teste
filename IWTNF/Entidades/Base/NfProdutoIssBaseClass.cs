               ...
               foreach (SearchParameterClass parametro in parametros) 
               {
                  ...
                  else
                  {
                     ...
                     if (parametro.FieldName == "NfItem" || parametro.FieldName == "id_nf_item")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_iss.id_nf_item = :nf_produto_iss_NfItem_8815 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_iss_NfItem_8815", NpgsqlDbType.Integer, ((AbstractEntity)parametro.Fieldvalue).ID));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "CodigoServico" || parametro.FieldName == "nps_codigo_servico")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_iss.nps_codigo_servico = :nf_produto_iss_CodigoServico_7108 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_iss_CodigoServico_7108", NpgsqlDbType.Integer, Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "CodMunicipioFatoGerador" || parametro.FieldName == "nps_cod_municipio_fato_gerador")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_iss.nps_cod_municipio_fato_gerador = :nf_produto_iss_CodMunicipioFatoGerador_5004 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_iss_CodMunicipioFatoGerador_5004", NpgsqlDbType.Integer, Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Aliquota" || parametro.FieldName == "nps_aliquota")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_iss.nps_aliquota = :nf_produto_iss_Aliquota_8676 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_iss_Aliquota_8676", NpgsqlDbType.Double, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "EntityUid" || parametro.FieldName == "entity_uid")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_iss.entity_uid LIKE :nf_produto_iss_EntityUid_5493 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_iss_EntityUid_5493", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Version" || parametro.FieldName == "version")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_iss.version = :nf_produto_iss_Version_970 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_iss_Version_970", NpgsqlDbType.Integer, Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "ID" || parametro.FieldName == "id_nf_produto_iss")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_iss.id_nf_produto_iss = :nf_produto_iss_ID_6204 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_iss_ID_6204", NpgsqlDbType.Bigint, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "EntityUidExato" || parametro.FieldName == "EntityUidExata")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_iss.entity_uid LIKE :nf_produto_iss_EntityUid_2762 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_iss_EntityUid_2762", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
