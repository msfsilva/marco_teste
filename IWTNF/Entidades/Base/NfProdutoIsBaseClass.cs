...
protected const string ErroUtilizado =  "Erro ao verificar se a entidade NfProdutoIsClass está sendo utilizada.";
       ...
       protected string _cClassTribIsOriginal{get;private set;}
       private string _cClassTribIsOriginalCommited{get; set;}
        private string _valueCClassTribIs;
         [Column("npl_c_class_trib_is")]
        public virtual string CClassTribIs
         { 
            get { return this._valueCClassTribIs; } 
            set 
            { 
                if (this._valueCClassTribIs == value)return;
                 this._valueCClassTribIs = value; 
            } 
        } 

       protected double? _pIsEspecOriginal{get;private set;}
       private double? _pIsEspecOriginalCommited{get; set;}
        private double? _valuePIsEspec;
         [Column("npl_p_is_espec")]
        public virtual double? PIsEspec
         { 
            get { return this._valuePIsEspec; } 
            set 
            { 
                if (this._valuePIsEspec == value)return;
                 this._valuePIsEspec = value; 
            } 
        } 

       protected string _uTribOriginal{get;private set;}
       private string _uTribOriginalCommited{get; set;}
        private string _valueUTrib;
         [Column("npl_u_trib")]
        public virtual string UTrib
         { 
            get { return this._valueUTrib; } 
            set 
            { 
                if (this._valueUTrib == value)return;
                 this._valueUTrib = value; 
            } 
        } 

       protected double? _qTribOriginal{get;private set;}
       private double? _qTribOriginalCommited{get; set;}
        private double? _valueQTrib;
         [Column("npl_q_trib")]
        public virtual double? QTrib
         { 
            get { return this._valueQTrib; } 
            set 
            { 
                if (this._valueQTrib == value)return;
                 this._valueQTrib = value; 
            } 
        } 
...
public static NfProdutoIsClass GetEntidade(long id, AcsUsuarioClass usuarioAtual, IWTPostgreNpgsqlConnection connection, Guid? operacao = null)
            ...
            try
            {
                if (this.ID != -1)
                {
                    command.CommandText =
                        ...
                        "  npl_v_is_dev = :npl_v_is_dev, " + 
                        "  npl_c_class_trib_is = :npl_c_class_trib_is, " + 
                        "  npl_p_is_espec = :npl_p_is_espec, " + 
                        "  npl_u_trib = :npl_u_trib, " + 
                        "  npl_q_trib = :npl_q_trib "+
                        "WHERE  " +
                        "  id_nf_produto_is = :id " +
                ...
                command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("npl_v_is_dev", NpgsqlDbType.Double));
                command.Parameters[command.Parameters.Count - 1].Value = (object)this.VIsDev ?? DBNull.Value;
                command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("npl_c_class_trib_is", NpgsqlDbType.Varchar));
                command.Parameters[command.Parameters.Count - 1].Value = (object)this.CClassTribIs ?? DBNull.Value;
                command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("npl_p_is_espec", NpgsqlDbType.Double));
                command.Parameters[command.Parameters.Count - 1].Value = (object)this.PIsEspec ?? DBNull.Value;
                command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("npl_u_trib", NpgsqlDbType.Varchar));
                command.Parameters[command.Parameters.Count - 1].Value = (object)this.UTrib ?? DBNull.Value;
                command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("npl_q_trib", NpgsqlDbType.Double));
                command.Parameters[command.Parameters.Count - 1].Value = (object)this.QTrib ?? DBNull.Value;
 ...
 toRet.CClassTribIs= entidadeCopiar.CClassTribIs;
 toRet.PIsEspec= entidadeCopiar.PIsEspec;
 toRet.UTrib= entidadeCopiar.UTrib;
 toRet.QTrib= entidadeCopiar.QTrib;
       ...
       _cClassTribIsOriginal = CClassTribIs;
       _cClassTribIsOriginalCommited = _cClassTribIsOriginal;
       _pIsEspecOriginal = PIsEspec;
       _pIsEspecOriginalCommited = _pIsEspecOriginal;
       _uTribOriginal = UTrib;
       _uTribOriginalCommited = _uTribOriginal;
       _qTribOriginal = QTrib;
       _qTribOriginalCommited = _qTribOriginal;
       ...
       _cClassTribIsOriginalCommited = CClassTribIs;
       _pIsEspecOriginalCommited = PIsEspec;
       _uTribOriginalCommited = UTrib;
       _qTribOriginalCommited = QTrib;
        ...
        protected override void RollbackChangesEntidade()
        {
            ...
            try
            {
               ...
               _vIsDevOriginalCommited=_vIsDevOriginal;
               CClassTribIs=_cClassTribIsOriginal;
               _cClassTribIsOriginalCommited=_cClassTribIsOriginal;
               PIsEspec=_pIsEspecOriginal;
               _pIsEspecOriginalCommited=_pIsEspecOriginal;
               UTrib=_uTribOriginal;
               _uTribOriginalCommited=_uTribOriginal;
               QTrib=_qTribOriginal;
               _qTribOriginalCommited=_qTribOriginal;
      ...
      if (dirty) return true;
       dirty = _cClassTribIsOriginal != CClassTribIs;
      if (dirty) return true;
       dirty = _pIsEspecOriginal != PIsEspec;
      if (dirty) return true;
       dirty = _uTribOriginal != UTrib;
      if (dirty) return true;
       dirty = _qTribOriginal != QTrib;
      ...
      if (dirty) return true;
       dirty = _cClassTribIsOriginalCommited != CClassTribIs;
      if (dirty) return true;
       dirty = _pIsEspecOriginalCommited != PIsEspec;
      if (dirty) return true;
       dirty = _uTribOriginalCommited != UTrib;
      if (dirty) return true;
       dirty = _qTribOriginalCommited != QTrib;
        ...
        public override object GetValorPropriedade(string nomePropriedade)
        {
          switch (nomePropriedade) 
          {
             ...
             case "VIsDev":
                return this.VIsDev;
             case "CClassTribIs":
                return this.CClassTribIs;
             case "PIsEspec":
                return this.PIsEspec;
             case "UTrib":
                return this.UTrib;
             case "QTrib":
                return this.QTrib;
        ...
        protected override List<AbstractEntity> NewSearch(List<SearchParameterClass> parametros, bool somenteCount,out int qtdRegistros, bool utilizarOr = false, int? offset = null, int? limit = null, bool utilizarBuffer = true, Guid? operacao = null)
        {
            ...
            try
            {
               ...
               command.CommandText += "nf_produto_is.npl_v_is_dev, " ;
               command.CommandText += "nf_produto_is.npl_c_class_trib_is, " ;
               command.CommandText += "nf_produto_is.npl_p_is_espec, " ;
               command.CommandText += "nf_produto_is.npl_u_trib, " ;
               command.CommandText += "nf_produto_is.npl_q_trib " ;
               }
               ...
               foreach (SearchParameterClass parametro in parametros) 
               {
                  if (parametro.Operacao == SearchOperacao.SomenteOrdenacao) 
                  {
                     ...
                     switch (parametro.TipoOrdenacao)
                     {
                        ...
                        case TipoOrdenacao.Data:
                        case TipoOrdenacao.Automatica:
                           orderByClause += " , nf_produto_is.npl_v_is_dev " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                        case TipoOrdenacao.String:
                           orderByClause += " , UPPER(nf_produto_is.npl_v_is_dev) " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                     }
                     break;
                     case "npl_c_class_trib_is":
                     case "CClassTribIs":
                     switch (parametro.TipoOrdenacao)
                     {
                        case TipoOrdenacao.Numerica:
                        case TipoOrdenacao.Data:
                           orderByClause += " , nf_produto_is.npl_c_class_trib_is " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                        case TipoOrdenacao.String:
                        case TipoOrdenacao.Automatica:
                           orderByClause += " , UPPER(nf_produto_is.npl_c_class_trib_is) " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                     }
                     break;
                     case "npl_p_is_espec":
                     ...
                     switch (parametro.TipoOrdenacao)
                     {
                        ...
                        case TipoOrdenacao.Data:
                        case TipoOrdenacao.Automatica:
                           orderByClause += " , nf_produto_is.npl_p_is_espec " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                        case TipoOrdenacao.String:
                           orderByClause += " , UPPER(nf_produto_is.npl_p_is_espec) " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                     }
                     break;
                     case "npl_u_trib":
                     ...
                     switch (parametro.TipoOrdenacao)
                     {
                        case TipoOrdenacao.Numerica:
                        case TipoOrdenacao.Data:
                           orderByClause += " , nf_produto_is.npl_u_trib " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                        case TipoOrdenacao.String:
                        case TipoOrdenacao.Automatica:
                           orderByClause += " , UPPER(nf_produto_is.npl_u_trib) " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                     }
                     break;
                     case "npl_q_trib":
                     ...
                     switch (parametro.TipoOrdenacao)
                     {
                        ...
                        case TipoOrdenacao.Data:
                        case TipoOrdenacao.Automatica:
                           orderByClause += " , nf_produto_is.npl_q_trib " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                        case TipoOrdenacao.String:
                           orderByClause += " , UPPER(nf_produto_is.npl_q_trib) " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                     }
                     break;
                        default:
                  ...
                  else
                  {
                     ...
                     if (parametro.FieldName == "BuscaCompleta")
                     {
                        ...
                        if (!CamposNaoIncluirBuscaCompleta.Contains("npl_c_class_trib_is")) 
                        {
                           whereClause += " OR UPPER(nf_produto_is.npl_c_class_trib_is) LIKE :buscaCompletaUpper ";
                           whereClause += " OR LOWER(nf_produto_is.npl_c_class_trib_is) LIKE :buscaCompletaLower ";
                        }
                        if (!CamposNaoIncluirBuscaCompleta.Contains("npl_u_trib")) 
                        {
                           whereClause += " OR UPPER(nf_produto_is.npl_u_trib) LIKE :buscaCompletaUpper ";
                           whereClause += " OR LOWER(nf_produto_is.npl_u_trib) LIKE :buscaCompletaLower ";
                        }
                        whereClause += ") ";
                     ...
                     if (parametro.FieldName == "ID" || parametro.FieldName == "id_nf_produto_is")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_is.id_nf_produto_is = :nf_produto_is_ID_8392 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_is_ID_8392", NpgsqlDbType.Bigint, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "NfItem" || parametro.FieldName == "id_nf_item")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_is.id_nf_item = :nf_produto_is_NfItem_8644 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_is_NfItem_8644", NpgsqlDbType.Integer, ((AbstractEntity)parametro.Fieldvalue).ID));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "CstIs" || parametro.FieldName == "npl_cst_is")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_is.npl_cst_is LIKE :nf_produto_is_CstIs_5742 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_is_CstIs_5742", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "VBaseCalcIs" || parametro.FieldName == "npl_v_base_calc_is")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_is.npl_v_base_calc_is = :nf_produto_is_VBaseCalcIs_8316 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_is_VBaseCalcIs_8316", NpgsqlDbType.Double, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "PIs" || parametro.FieldName == "npl_p_is")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_is.npl_p_is = :nf_produto_is_PIs_6635 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_is_PIs_6635", NpgsqlDbType.Double, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "VBaseCalcIsRet" || parametro.FieldName == "npl_v_base_calc_is_ret")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_is.npl_v_base_calc_is_ret = :nf_produto_is_VBaseCalcIsRet_4641 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_is_VBaseCalcIsRet_4641", NpgsqlDbType.Double, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "PIsRet" || parametro.FieldName == "npl_p_is_ret")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_is.npl_p_is_ret = :nf_produto_is_PIsRet_4172 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_is_PIsRet_4172", NpgsqlDbType.Double, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "IndIsRet" || parametro.FieldName == "npl_ind_is_ret")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_is.npl_ind_is_ret = :nf_produto_is_IndIsRet_6028 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_is_IndIsRet_6028", NpgsqlDbType.Smallint, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "IndSomIs" || parametro.FieldName == "npl_ind_som_is")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_is.npl_ind_som_is = :nf_produto_is_IndSomIs_9409 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_is_IndSomIs_9409", NpgsqlDbType.Smallint, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "CompoeTotal" || parametro.FieldName == "npl_compoe_total")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_is.npl_compoe_total = :nf_produto_is_CompoeTotal_9711 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_is_CompoeTotal_9711", NpgsqlDbType.Smallint, Convert.ToInt16(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Version" || parametro.FieldName == "version")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_is.version = :nf_produto_is_Version_3718 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_is_Version_3718", NpgsqlDbType.Integer, Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "EntityUid" || parametro.FieldName == "entity_uid")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_is.entity_uid LIKE :nf_produto_is_EntityUid_1666 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_is_EntityUid_1666", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "VIsDev" || parametro.FieldName == "npl_v_is_dev")
                     {
                      if (parametro.Fieldvalue != null && (!(parametro.Fieldvalue is double?)))
                      {
                         throw new ExcecaoTratada("O parâmetro " + parametro.FieldName + " fornecido não é do tipo double?");
                      ...
                      if (parametro.Fieldvalue == null)
                      {
                         whereClause += "  nf_produto_is.npl_v_is_dev IS NULL" ;
                      }
                      else
                      {
                         whereClause += "  nf_produto_is.npl_v_is_dev = :nf_produto_is_VIsDev_6055 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_is_VIsDev_6055", NpgsqlDbType.Double, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "CClassTribIs" || parametro.FieldName == "npl_c_class_trib_is")
                     {
                      if (parametro.Fieldvalue != null && (!(parametro.Fieldvalue is string)))
                      {
                         throw new ExcecaoTratada("O parâmetro " + parametro.FieldName + " fornecido não é do tipo string");
                      ...
                      if (parametro.Fieldvalue == null)
                      {
                         whereClause += "  nf_produto_is.npl_c_class_trib_is IS NULL" ;
                      }
                      else
                      {
                         whereClause += "  nf_produto_is.npl_c_class_trib_is LIKE :nf_produto_is_CClassTribIs_2626 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_is_CClassTribIs_2626", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "PIsEspec" || parametro.FieldName == "npl_p_is_espec")
                     {
                      if (parametro.Fieldvalue != null && (!(parametro.Fieldvalue is double?)))
                      {
                         throw new ExcecaoTratada("O parâmetro " + parametro.FieldName + " fornecido não é do tipo double?");
                      ...
                      if (parametro.Fieldvalue == null)
                      {
                         whereClause += "  nf_produto_is.npl_p_is_espec IS NULL" ;
                      }
                      else
                      {
                         whereClause += "  nf_produto_is.npl_p_is_espec = :nf_produto_is_PIsEspec_6139 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_is_PIsEspec_6139", NpgsqlDbType.Double, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "UTrib" || parametro.FieldName == "npl_u_trib")
                     {
                      if (parametro.Fieldvalue != null && (!(parametro.Fieldvalue is string)))
                      {
                         throw new ExcecaoTratada("O parâmetro " + parametro.FieldName + " fornecido não é do tipo string");
                      ...
                      if (parametro.Fieldvalue == null)
                      {
                         whereClause += "  nf_produto_is.npl_u_trib IS NULL" ;
                      }
                      else
                      {
                         whereClause += "  nf_produto_is.npl_u_trib LIKE :nf_produto_is_UTrib_2116 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_is_UTrib_2116", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "QTrib" || parametro.FieldName == "npl_q_trib")
                     {
                      if (parametro.Fieldvalue != null && (!(parametro.Fieldvalue is double?)))
                      {
                         throw new ExcecaoTratada("O parâmetro " + parametro.FieldName + " fornecido não é do tipo double?");
                      ...
                      if (parametro.Fieldvalue == null)
                      {
                         whereClause += "  nf_produto_is.npl_q_trib IS NULL" ;
                      }
                      else
                      {
                         whereClause += "  nf_produto_is.npl_q_trib = :nf_produto_is_QTrib_8452 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_is_QTrib_8452", NpgsqlDbType.Double, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "CstIsExato" || parametro.FieldName == "CstIsExata")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_is.npl_cst_is LIKE :nf_produto_is_CstIs_3445 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_is_CstIs_3445", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "EntityUidExato" || parametro.FieldName == "EntityUidExata")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_is.entity_uid LIKE :nf_produto_is_EntityUid_2967 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_is_EntityUid_2967", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "CClassTribIsExato" || parametro.FieldName == "CClassTribIsExata")
                     {
                      if (parametro.Fieldvalue != null && (!(parametro.Fieldvalue is string)))
                      {
                         throw new ExcecaoTratada("O parâmetro " + parametro.FieldName + " fornecido não é do tipo string");
                      ...
                      {
                         whereClause += "  nf_produto_is.npl_c_class_trib_is LIKE :nf_produto_is_CClassTribIs_4069 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_is_CClassTribIs_4069", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "UTribExato" || parametro.FieldName == "UTribExata")
                     {
                      if (parametro.Fieldvalue != null && (!(parametro.Fieldvalue is string)))
                      {
                         throw new ExcecaoTratada("O parâmetro " + parametro.FieldName + " fornecido não é do tipo string");
                      ...
                      {
                         whereClause += "  nf_produto_is.npl_u_trib LIKE :nf_produto_is_UTrib_2786 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_is_UTrib_2786", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
...
if (!operacao.HasValue)
{
    operacao = Guid.NewGuid();
                  ...
                  if (entidade == null)
                  {
                     ...
                     entidade.VIsDev = read["npl_v_is_dev"] as double?;
                     entidade.CClassTribIs = (read["npl_c_class_trib_is"] != DBNull.Value ? read["npl_c_class_trib_is"].ToString() : null);
                     entidade.PIsEspec = read["npl_p_is_espec"] as double?;
                     entidade.UTrib = (read["npl_u_trib"] != DBNull.Value ? read["npl_u_trib"].ToString() : null);
                     entidade.QTrib = read["npl_q_trib"] as double?;
