               ...
               foreach (SearchParameterClass parametro in parametros) 
               {
                  ...
                  else
                  {
                     ...
                     if (parametro.FieldName == "NfItem" || parametro.FieldName == "id_nf_item")
                     {
                      ...
                      {
                         whereClause += "  nf_item_tributo_iimp.id_nf_item = :nf_item_tributo_iimp_NfItem_7011 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_item_tributo_iimp_NfItem_7011", NpgsqlDbType.Integer, ((AbstractEntity)parametro.Fieldvalue).ID));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Aliquota" || parametro.FieldName == "ntm_aliquota")
                     {
                      ...
                      {
                         whereClause += "  nf_item_tributo_iimp.ntm_aliquota = :nf_item_tributo_iimp_Aliquota_6906 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_item_tributo_iimp_Aliquota_6906", NpgsqlDbType.Double, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "ModalidadeTributacao" || parametro.FieldName == "ntm_modalidade_tributacao")
                     {
                      ...
                      {
                         whereClause += "  nf_item_tributo_iimp.ntm_modalidade_tributacao = :nf_item_tributo_iimp_ModalidadeTributacao_30 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_item_tributo_iimp_ModalidadeTributacao_30", NpgsqlDbType.Smallint,  Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "ValorBc" || parametro.FieldName == "ntm_valor_bc")
                     {
                      ...
                      {
                         whereClause += "  nf_item_tributo_iimp.ntm_valor_bc = :nf_item_tributo_iimp_ValorBc_2207 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_item_tributo_iimp_ValorBc_2207", NpgsqlDbType.Double, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "QuantidadeVendida" || parametro.FieldName == "ntm_quantidade_vendida")
                     {
                      ...
                      {
                         whereClause += "  nf_item_tributo_iimp.ntm_quantidade_vendida = :nf_item_tributo_iimp_QuantidadeVendida_9313 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_item_tributo_iimp_QuantidadeVendida_9313", NpgsqlDbType.Double, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "ValorIimp" || parametro.FieldName == "ntm_valor_iimp")
                     {
                      ...
                      {
                         whereClause += "  nf_item_tributo_iimp.ntm_valor_iimp = :nf_item_tributo_iimp_ValorIimp_6704 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_item_tributo_iimp_ValorIimp_6704", NpgsqlDbType.Double, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "ValorDespesasAduaneiras" || parametro.FieldName == "ntm_valor_despesas_aduaneiras")
                     {
                      ...
                      {
                         whereClause += "  nf_item_tributo_iimp.ntm_valor_despesas_aduaneiras = :nf_item_tributo_iimp_ValorDespesasAduaneiras_4095 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_item_tributo_iimp_ValorDespesasAduaneiras_4095", NpgsqlDbType.Double, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "ValorIof" || parametro.FieldName == "ntm_valor_iof")
                     {
                      ...
                      {
                         whereClause += "  nf_item_tributo_iimp.ntm_valor_iof = :nf_item_tributo_iimp_ValorIof_6909 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_item_tributo_iimp_ValorIof_6909", NpgsqlDbType.Double, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "EntityUid" || parametro.FieldName == "entity_uid")
                     {
                      ...
                      {
                         whereClause += "  nf_item_tributo_iimp.entity_uid LIKE :nf_item_tributo_iimp_EntityUid_9805 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_item_tributo_iimp_EntityUid_9805", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Version" || parametro.FieldName == "version")
                     {
                      ...
                      {
                         whereClause += "  nf_item_tributo_iimp.version = :nf_item_tributo_iimp_Version_2827 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_item_tributo_iimp_Version_2827", NpgsqlDbType.Integer, Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "ID" || parametro.FieldName == "id_nf_item_tributo_iimp")
                     {
                      ...
                      {
                         whereClause += "  nf_item_tributo_iimp.id_nf_item_tributo_iimp = :nf_item_tributo_iimp_ID_2438 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_item_tributo_iimp_ID_2438", NpgsqlDbType.Bigint, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "EntityUidExato" || parametro.FieldName == "EntityUidExata")
                     {
                      ...
                      {
                         whereClause += "  nf_item_tributo_iimp.entity_uid LIKE :nf_item_tributo_iimp_EntityUid_385 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_item_tributo_iimp_EntityUid_385", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
