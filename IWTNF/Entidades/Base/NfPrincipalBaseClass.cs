...
protected const string ErroCollectionNfPagamentoAntecipadoClassNfPrincipal = "Erro ao carregar a coleção de NfPagamentoAntecipadoClass.";
...
protected const string MensagemUtilizadoCollectionNfPagamentoAntecipadoClassNfPrincipal =  "A entidade NfPrincipalClass está sendo utilizada nos seguintes NfPagamentoAntecipadoClass:";
...
protected const string ErroUtilizado =  "Erro ao verificar se a entidade NfPrincipalClass está sendo utilizada.";
       ...
       protected string _cMunFgIbsOriginal{get;private set;}
       private string _cMunFgIbsOriginalCommited{get; set;}
        private string _valueCMunFgIbs;
         [Column("npr_c_mun_fg_ibs")]
        public virtual string CMunFgIbs
         { 
            get { return this._valueCMunFgIbs; } 
            set 
            { 
                if (this._valueCMunFgIbs == value)return;
                 this._valueCMunFgIbs = value; 
            } 
        } 

       protected string _tpNfDebitoOriginal{get;private set;}
       private string _tpNfDebitoOriginalCommited{get; set;}
        private string _valueTpNfDebito;
         [Column("npr_tp_nf_debito")]
        public virtual string TpNfDebito
         { 
            get { return this._valueTpNfDebito; } 
            set 
            { 
                if (this._valueTpNfDebito == value)return;
                 this._valueTpNfDebito = value; 
            } 
        } 

       protected string _tpNfCreditoOriginal{get;private set;}
       private string _tpNfCreditoOriginalCommited{get; set;}
        private string _valueTpNfCredito;
         [Column("npr_tp_nf_credito")]
        public virtual string TpNfCredito
         { 
            get { return this._valueTpNfCredito; } 
            set 
            { 
                if (this._valueTpNfCredito == value)return;
                 this._valueTpNfCredito = value; 
            } 
        } 

       protected short? _tpEnteGovOriginal{get;private set;}
       private short? _tpEnteGovOriginalCommited{get; set;}
        private short? _valueTpEnteGov;
         [Column("npr_tp_ente_gov")]
        public virtual short? TpEnteGov
         { 
            get { return this._valueTpEnteGov; } 
            set 
            { 
                if (this._valueTpEnteGov == value)return;
                 this._valueTpEnteGov = value; 
            } 
        } 

       protected double? _pRedutorOriginal{get;private set;}
       private double? _pRedutorOriginalCommited{get; set;}
        private double? _valuePRedutor;
         [Column("npr_p_redutor")]
        public virtual double? PRedutor
         { 
            get { return this._valuePRedutor; } 
            set 
            { 
                if (this._valuePRedutor == value)return;
                 this._valuePRedutor = value; 
            } 
        } 

       protected short? _tpOperGovOriginal{get;private set;}
       private short? _tpOperGovOriginalCommited{get; set;}
        private short? _valueTpOperGov;
         [Column("npr_tp_oper_gov")]
        public virtual short? TpOperGov
         { 
            get { return this._valueTpOperGov; } 
            set 
            { 
                if (this._valueTpOperGov == value)return;
                 this._valueTpOperGov = value; 
            } 
        } 
...
return this._valueCollectionNfPagamentoClassNfPrincipal; } 
       ...
       private List<long> _collectionNfPagamentoAntecipadoClassNfPrincipalOriginal;
       private List<Entidades.NfPagamentoAntecipadoClass > _collectionNfPagamentoAntecipadoClassNfPrincipalRemovidos;
       [UnCloneable(UnCloneableAttributeType.RetFalse)] 
       protected bool _valueCollectionNfPagamentoAntecipadoClassNfPrincipalLoaded { get; set;} 
       [UnCloneable(UnCloneableAttributeType.RetFalse)] 
       protected bool _valueCollectionNfPagamentoAntecipadoClassNfPrincipalChanged { get; private set;} 
       [UnCloneable(UnCloneableAttributeType.RetFalse)] 
       protected bool _valueCollectionNfPagamentoAntecipadoClassNfPrincipalCommitedChanged { get; private set;} 
       [UnCloneable(UnCloneableAttributeType.RetNull)] 
       protected BindingList<Entidades.NfPagamentoAntecipadoClass> _valueCollectionNfPagamentoAntecipadoClassNfPrincipal { get; set;} 
       [UnCloneable(UnCloneableAttributeType.RetPadrao)] 
       public BindingList<Entidades.NfPagamentoAntecipadoClass> CollectionNfPagamentoAntecipadoClassNfPrincipal 
       { 
           get { if(!_valueCollectionNfPagamentoAntecipadoClassNfPrincipalLoaded && !this.DisableLoadCollection){this.LoadCollectionNfPagamentoAntecipadoClassNfPrincipal();}
return this._valueCollectionNfPagamentoAntecipadoClassNfPrincipal; } 
           set 
           { 
               this._valueCollectionNfPagamentoAntecipadoClassNfPrincipal = value; 
               this._valueCollectionNfPagamentoAntecipadoClassNfPrincipalLoaded = true; 
           } 
       } 
...
public static NfPrincipalClass GetEntidade(long id, AcsUsuarioClass usuarioAtual, IWTPostgreNpgsqlConnection connection, Guid? operacao = null)
        ...
        private void CollectionNfPagamentoAntecipadoClassNfPrincipalChangedEvent(object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
           if (DisableEventosRemocaoVetores) return;
           switch (e.Action) 
           { 
             case NotifyCollectionChangedAction.Add: 
                  _valueCollectionNfPagamentoAntecipadoClassNfPrincipalChanged = true;
                  _valueCollectionNfPagamentoAntecipadoClassNfPrincipalCommitedChanged = true;
                 break; 
             case NotifyCollectionChangedAction.Remove: 
             case NotifyCollectionChangedAction.Replace: 
             case NotifyCollectionChangedAction.Move: 
                  _valueCollectionNfPagamentoAntecipadoClassNfPrincipalChanged = true; 
                  _valueCollectionNfPagamentoAntecipadoClassNfPrincipalCommitedChanged = true;
                 foreach (Entidades.NfPagamentoAntecipadoClass item in e.OldItems) 
                 { 
                     _collectionNfPagamentoAntecipadoClassNfPrincipalRemovidos.Add(item); 
                 } 
                 break; 
             case NotifyCollectionChangedAction.Reset: 
                  _valueCollectionNfPagamentoAntecipadoClassNfPrincipalChanged = true; 
                  _valueCollectionNfPagamentoAntecipadoClassNfPrincipalCommitedChanged = true;
                 foreach (Entidades.NfPagamentoAntecipadoClass item in _valueCollectionNfPagamentoAntecipadoClassNfPrincipal) 
                 { 
                     _collectionNfPagamentoAntecipadoClassNfPrincipalRemovidos.Add(item); 
                 } 
                 break; 
         ...
         protected void LoadCollectionNfPagamentoAntecipadoClassNfPrincipal()
         {
            try
            {
                 ObservableCollection<Entidades.NfPagamentoAntecipadoClass> oc;
                _valueCollectionNfPagamentoAntecipadoClassNfPrincipalChanged = false;
                 _valueCollectionNfPagamentoAntecipadoClassNfPrincipalCommitedChanged = false;
                _collectionNfPagamentoAntecipadoClassNfPrincipalRemovidos = new List<Entidades.NfPagamentoAntecipadoClass>();
                if (this.ID == -1) 
                {
                     oc = new ObservableCollection<Entidades.NfPagamentoAntecipadoClass>();
                }
                else{ 
                   Entidades.NfPagamentoAntecipadoClass search = new Entidades.NfPagamentoAntecipadoClass(this.UsuarioAtual, SingleConnection);
                   search.BufferSecundario = this.BufferSecundario; 
                    oc = 
                      new ObservableCollection<Entidades.NfPagamentoAntecipadoClass>(                        search.Search(new List<SearchParameterClass>() {                            new SearchParameterClass("NfPrincipal", this),                     }                       ).Cast<Entidades.NfPagamentoAntecipadoClass>().ToList());
                 }
                 _valueCollectionNfPagamentoAntecipadoClassNfPrincipal = new BindingList<Entidades.NfPagamentoAntecipadoClass>(oc); 
                 _collectionNfPagamentoAntecipadoClassNfPrincipalOriginal= (from a in _valueCollectionNfPagamentoAntecipadoClassNfPrincipal select a.ID).ToList();
                 _valueCollectionNfPagamentoAntecipadoClassNfPrincipalLoaded = true;
                 oc.CollectionChanged += CollectionNfPagamentoAntecipadoClassNfPrincipalChangedEvent; 
            }
            catch (Exception e)
            {
                throw new Exception(ErroCollectionNfPagamentoAntecipadoClassNfPrincipal+"\r\n" + e.Message, e);
            }
         } 
            ...
            try
            {
                if (this.ID != -1)
                {
                    command.CommandText =
                        ...
                        "  npr_c_mun_fg_ibs = :npr_c_mun_fg_ibs, " + 
                        "  npr_tp_nf_debito = :npr_tp_nf_debito, " + 
                        "  npr_tp_nf_credito = :npr_tp_nf_credito, " + 
                        "  npr_tp_ente_gov = :npr_tp_ente_gov, " + 
                        "  npr_p_redutor = :npr_p_redutor, " + 
                        "  npr_tp_oper_gov = :npr_tp_oper_gov "+
                        "WHERE  " +
                        "  id_nf_principal = :id " +
                ...
                command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("npr_c_mun_fg_ibs", NpgsqlDbType.Varchar));
                command.Parameters[command.Parameters.Count - 1].Value = (object)this.CMunFgIbs ?? DBNull.Value;
                command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("npr_tp_nf_debito", NpgsqlDbType.Varchar));
                command.Parameters[command.Parameters.Count - 1].Value = (object)this.TpNfDebito ?? DBNull.Value;
                command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("npr_tp_nf_credito", NpgsqlDbType.Varchar));
                command.Parameters[command.Parameters.Count - 1].Value = (object)this.TpNfCredito ?? DBNull.Value;
                command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("npr_tp_ente_gov", NpgsqlDbType.Smallint));
                command.Parameters[command.Parameters.Count - 1].Value = (object)this.TpEnteGov ?? DBNull.Value;
                command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("npr_p_redutor", NpgsqlDbType.Double));
                command.Parameters[command.Parameters.Count - 1].Value = (object)this.PRedutor ?? DBNull.Value;
                command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("npr_tp_oper_gov", NpgsqlDbType.Smallint));
                command.Parameters[command.Parameters.Count - 1].Value = (object)this.TpOperGov ?? DBNull.Value;
 ...
 if (CollectionNfPagamentoAntecipadoClassNfPrincipal.Count > 0) 
            {
                mensagemUtilizado = MensagemUtilizadoCollectionNfPagamentoAntecipadoClassNfPrincipal+"\r\n";
                foreach (Entidades.NfPagamentoAntecipadoClass tmp in CollectionNfPagamentoAntecipadoClassNfPrincipal)
                {
                    mensagemUtilizado += tmp.ToString() + "\r\n";
                }
                return true;
 ...
 toRet.CMunFgIbs= entidadeCopiar.CMunFgIbs;
 toRet.TpNfDebito= entidadeCopiar.TpNfDebito;
 toRet.TpNfCredito= entidadeCopiar.TpNfCredito;
 toRet.TpEnteGov= entidadeCopiar.TpEnteGov;
 toRet.PRedutor= entidadeCopiar.PRedutor;
 toRet.TpOperGov= entidadeCopiar.TpOperGov;
       ...
       _cMunFgIbsOriginal = CMunFgIbs;
       _cMunFgIbsOriginalCommited = _cMunFgIbsOriginal;
       _tpNfDebitoOriginal = TpNfDebito;
       _tpNfDebitoOriginalCommited = _tpNfDebitoOriginal;
       _tpNfCreditoOriginal = TpNfCredito;
       _tpNfCreditoOriginalCommited = _tpNfCreditoOriginal;
       _tpEnteGovOriginal = TpEnteGov;
       _tpEnteGovOriginalCommited = _tpEnteGovOriginal;
       _pRedutorOriginal = PRedutor;
       _pRedutorOriginalCommited = _pRedutorOriginal;
       _tpOperGovOriginal = TpOperGov;
       _tpOperGovOriginalCommited = _tpOperGovOriginal;
       ...
       _cMunFgIbsOriginalCommited = CMunFgIbs;
       _tpNfDebitoOriginalCommited = TpNfDebito;
       _tpNfCreditoOriginalCommited = TpNfCredito;
       _tpEnteGovOriginalCommited = TpEnteGov;
       _pRedutorOriginalCommited = PRedutor;
       _tpOperGovOriginalCommited = TpOperGov;
        ...
        protected override void CommitChangesEntidade()
        {
            try
            {
               ...
               if (_valueCollectionNfPagamentoAntecipadoClassNfPrincipalLoaded) 
               {
                  if (_collectionNfPagamentoAntecipadoClassNfPrincipalRemovidos != null) 
                  {
                     _collectionNfPagamentoAntecipadoClassNfPrincipalRemovidos.Clear();
                  }
                  else 
                  {
                      _collectionNfPagamentoAntecipadoClassNfPrincipalRemovidos = new List<Entidades.NfPagamentoAntecipadoClass>();
        ...
        protected override void RollbackChangesEntidade()
        {
            ...
            try
            {
               ...
               _estoqueMovimentadoOriginalCommited=_estoqueMovimentadoOriginal;
               CMunFgIbs=_cMunFgIbsOriginal;
               _cMunFgIbsOriginalCommited=_cMunFgIbsOriginal;
               TpNfDebito=_tpNfDebitoOriginal;
               _tpNfDebitoOriginalCommited=_tpNfDebitoOriginal;
               TpNfCredito=_tpNfCreditoOriginal;
               _tpNfCreditoOriginalCommited=_tpNfCreditoOriginal;
               TpEnteGov=_tpEnteGovOriginal;
               _tpEnteGovOriginalCommited=_tpEnteGovOriginal;
               PRedutor=_pRedutorOriginal;
               _pRedutorOriginalCommited=_pRedutorOriginal;
               TpOperGov=_tpOperGovOriginal;
               _tpOperGovOriginalCommited=_tpOperGovOriginal;
               if (_valueCollectionNfAtributoClassNfPrincipalLoaded) 
               {
               ...
               if (_valueCollectionNfPagamentoAntecipadoClassNfPrincipalLoaded) 
               {
                  CollectionNfPagamentoAntecipadoClassNfPrincipal.Clear();
                  foreach(int item in _collectionNfPagamentoAntecipadoClassNfPrincipalOriginal)
                  {
                    CollectionNfPagamentoAntecipadoClassNfPrincipal.Add(Entidades.NfPagamentoAntecipadoClass.GetEntidade(item, UsuarioAtual, SingleConnection));
                  }
                  _collectionNfPagamentoAntecipadoClassNfPrincipalRemovidos.Clear();
               }
               if (_valueCollectionNfPrincipalClassNfPrincipalSubstituidaLoaded) 
        ...
        protected override bool DirtyCollections()
        {
            ...
            try
            {
               ...
               if (_valueCollectionNfPagamentoAntecipadoClassNfPrincipalLoaded) 
               {
                  if (_valueCollectionNfPagamentoAntecipadoClassNfPrincipalChanged)
                  {
                     return true;
                  }
               }
               ...
               if (_valueCollectionNfPagamentoAntecipadoClassNfPrincipalLoaded) 
               {
                   tempRet = CollectionNfPagamentoAntecipadoClassNfPrincipal.Any(item => item.IsDirty());
                   if (tempRet) return true;
               }
               if (_valueCollectionNfPrincipalClassNfPrincipalSubstituidaLoaded) 
               {
      ...
      if (dirty) return true;
       dirty = _cMunFgIbsOriginal != CMunFgIbs;
      if (dirty) return true;
       dirty = _tpNfDebitoOriginal != TpNfDebito;
      if (dirty) return true;
       dirty = _tpNfCreditoOriginal != TpNfCredito;
      if (dirty) return true;
       dirty = _tpEnteGovOriginal != TpEnteGov;
      if (dirty) return true;
       dirty = _pRedutorOriginal != PRedutor;
      if (dirty) return true;
       dirty = _tpOperGovOriginal != TpOperGov;
        ...
        protected override bool DirtyCollectionsCommited()
        {
            ...
            try
            {
               ...
               if (_valueCollectionNfPagamentoAntecipadoClassNfPrincipalLoaded) 
               {
                  if (_valueCollectionNfPagamentoAntecipadoClassNfPrincipalCommitedChanged)
                  {
                     return true;
                  }
               }
               ...
               if (_valueCollectionNfPagamentoAntecipadoClassNfPrincipalLoaded) 
               {
                   tempRet = CollectionNfPagamentoAntecipadoClassNfPrincipal.Any(item => item.IsDirtyCommited());
                   if (tempRet) return true;
               }
               if (_valueCollectionNfPrincipalClassNfPrincipalSubstituidaLoaded) 
               {
      ...
      if (dirty) return true;
       dirty = _cMunFgIbsOriginalCommited != CMunFgIbs;
      if (dirty) return true;
       dirty = _tpNfDebitoOriginalCommited != TpNfDebito;
      if (dirty) return true;
       dirty = _tpNfCreditoOriginalCommited != TpNfCredito;
      if (dirty) return true;
       dirty = _tpEnteGovOriginalCommited != TpEnteGov;
      if (dirty) return true;
       dirty = _pRedutorOriginalCommited != PRedutor;
      if (dirty) return true;
       dirty = _tpOperGovOriginalCommited != TpOperGov;
        ...
        protected override void SaveCollections(ref IWTPostgreNpgsqlCommand command)
        {
            ...
            try
            {
               ...
               if (_valueCollectionNfPagamentoAntecipadoClassNfPrincipalLoaded) 
               {
                  foreach(NfPagamentoAntecipadoClass item in CollectionNfPagamentoAntecipadoClassNfPrincipal)
                  {
                     item.Save(ref command, propagado:true);
                  }
               }
        ...
        protected override List<AbstractEntity> NewSearch(List<SearchParameterClass> parametros, bool somenteCount,out int qtdRegistros, bool utilizarOr = false, int? offset = null, int? limit = null, bool utilizarBuffer = true, Guid? operacao = null)
        {
            ...
            try
            {
               ...
               command.CommandText += "nf_principal.npr_c_mun_fg_ibs, " ;
               command.CommandText += "nf_principal.npr_tp_nf_debito, " ;
               command.CommandText += "nf_principal.npr_tp_nf_credito, " ;
               command.CommandText += "nf_principal.npr_tp_ente_gov, " ;
               command.CommandText += "nf_principal.npr_p_redutor, " ;
               command.CommandText += "nf_principal.npr_tp_oper_gov " ;
               }
               ...
               foreach (SearchParameterClass parametro in parametros) 
               {
                  if (parametro.Operacao == SearchOperacao.SomenteOrdenacao) 
                  {
                     ...
                     break;
                     case "npr_c_mun_fg_ibs":
                     case "CMunFgIbs":
                     switch (parametro.TipoOrdenacao)
                     {
                        case TipoOrdenacao.Numerica:
                        case TipoOrdenacao.Data:
                           orderByClause += " , nf_principal.npr_c_mun_fg_ibs " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                        case TipoOrdenacao.String:
                        case TipoOrdenacao.Automatica:
                           orderByClause += " , UPPER(nf_principal.npr_c_mun_fg_ibs) " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                     }
                     break;
                     case "npr_tp_nf_debito":
                     case "TpNfDebito":
                     switch (parametro.TipoOrdenacao)
                     {
                        case TipoOrdenacao.Numerica:
                        case TipoOrdenacao.Data:
                           orderByClause += " , nf_principal.npr_tp_nf_debito " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                        case TipoOrdenacao.String:
                        case TipoOrdenacao.Automatica:
                           orderByClause += " , UPPER(nf_principal.npr_tp_nf_debito) " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                     }
                     break;
                     case "npr_tp_nf_credito":
                     case "TpNfCredito":
                     switch (parametro.TipoOrdenacao)
                     {
                        case TipoOrdenacao.Numerica:
                        case TipoOrdenacao.Data:
                           orderByClause += " , nf_principal.npr_tp_nf_credito " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                        case TipoOrdenacao.String:
                        case TipoOrdenacao.Automatica:
                           orderByClause += " , UPPER(nf_principal.npr_tp_nf_credito) " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                     }
                     break;
                     case "npr_tp_ente_gov":
                     case "TpEnteGov":
                     switch (parametro.TipoOrdenacao)
                     {
                        case TipoOrdenacao.Numerica:
                        case TipoOrdenacao.Data:
                        case TipoOrdenacao.Automatica:
                           orderByClause += " , nf_principal.npr_tp_ente_gov " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                        case TipoOrdenacao.String:
                           orderByClause += " , UPPER(nf_principal.npr_tp_ente_gov) " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                     }
                     break;
                     case "npr_p_redutor":
                     ...
                     switch (parametro.TipoOrdenacao)
                     {
                        ...
                        case TipoOrdenacao.Data:
                        case TipoOrdenacao.Automatica:
                           orderByClause += " , nf_principal.npr_p_redutor " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                        case TipoOrdenacao.String:
                           orderByClause += " , UPPER(nf_principal.npr_p_redutor) " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                     }
                     break;
                     case "npr_tp_oper_gov":
                     case "TpOperGov":
                     switch (parametro.TipoOrdenacao)
                     {
                        case TipoOrdenacao.Numerica:
                        case TipoOrdenacao.Data:
                        case TipoOrdenacao.Automatica:
                           orderByClause += " , nf_principal.npr_tp_oper_gov " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                        case TipoOrdenacao.String:
                           orderByClause += " , UPPER(nf_principal.npr_tp_oper_gov) " + parametro.Ordenacao.ToString().ToUpper(); 
                           break;
                     }
                     break;
                        default:
                  ...
                  else
                  {
                     ...
                     if (parametro.FieldName == "BuscaCompleta")
                     {
                        ...
                        if (!CamposNaoIncluirBuscaCompleta.Contains("npr_c_mun_fg_ibs")) 
                        {
                           whereClause += " OR UPPER(nf_principal.npr_c_mun_fg_ibs) LIKE :buscaCompletaUpper ";
                           whereClause += " OR LOWER(nf_principal.npr_c_mun_fg_ibs) LIKE :buscaCompletaLower ";
                        }
                        if (!CamposNaoIncluirBuscaCompleta.Contains("npr_tp_nf_debito")) 
                        {
                           whereClause += " OR UPPER(nf_principal.npr_tp_nf_debito) LIKE :buscaCompletaUpper ";
                           whereClause += " OR LOWER(nf_principal.npr_tp_nf_debito) LIKE :buscaCompletaLower ";
                        }
                        if (!CamposNaoIncluirBuscaCompleta.Contains("npr_tp_nf_credito")) 
                        {
                           whereClause += " OR UPPER(nf_principal.npr_tp_nf_credito) LIKE :buscaCompletaUpper ";
                           whereClause += " OR LOWER(nf_principal.npr_tp_nf_credito) LIKE :buscaCompletaLower ";
                        }
                        whereClause += ") ";
                     ...
                     if (parametro.FieldName == "ID" || parametro.FieldName == "id_nf_principal")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.id_nf_principal = :nf_principal_ID_8309 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_ID_8309", NpgsqlDbType.Bigint, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Numero" || parametro.FieldName == "nfp_numero")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_numero = :nf_principal_Numero_2177 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_Numero_2177", NpgsqlDbType.Integer, Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "NaturezaOperacao" || parametro.FieldName == "nfp_natureza_operacao")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_natureza_operacao LIKE :nf_principal_NaturezaOperacao_4183 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_NaturezaOperacao_4183", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Serie" || parametro.FieldName == "nfp_serie")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_serie = :nf_principal_Serie_9057 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_Serie_9057", NpgsqlDbType.Integer, Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "FormaPagamento" || parametro.FieldName == "nfp_forma_pagamento")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_forma_pagamento = :nf_principal_FormaPagamento_3027 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_FormaPagamento_3027", NpgsqlDbType.Smallint,  Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "ModeloDocFiscal" || parametro.FieldName == "nfp_modelo_doc_fiscal")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_modelo_doc_fiscal LIKE :nf_principal_ModeloDocFiscal_3895 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_ModeloDocFiscal_3895", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "DataEmissao" || parametro.FieldName == "nfp_data_emissao")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_data_emissao = :nf_principal_DataEmissao_7161 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_DataEmissao_7161", NpgsqlDbType.Timestamp, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "DataSaidaEntrada" || parametro.FieldName == "nfp_data_saida_entrada")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_data_saida_entrada = :nf_principal_DataSaidaEntrada_3882 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_DataSaidaEntrada_3882", NpgsqlDbType.Timestamp, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Tipo" || parametro.FieldName == "nfp_tipo")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_tipo = :nf_principal_Tipo_2434 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_Tipo_2434", NpgsqlDbType.Smallint,  Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "CodMunicipioFatoGerador" || parametro.FieldName == "nfp_cod_municipio_fato_gerador")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_cod_municipio_fato_gerador = :nf_principal_CodMunicipioFatoGerador_3917 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_CodMunicipioFatoGerador_3917", NpgsqlDbType.Integer, Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "FormatoImpressao" || parametro.FieldName == "nfp_formato_impressao")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_formato_impressao = :nf_principal_FormatoImpressao_2559 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_FormatoImpressao_2559", NpgsqlDbType.Smallint,  Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "FormaEmissao" || parametro.FieldName == "nfp_forma_emissao")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_forma_emissao = :nf_principal_FormaEmissao_7044 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_FormaEmissao_7044", NpgsqlDbType.Smallint,  Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "IdentificacaoAmbiente" || parametro.FieldName == "nfp_identificacao_ambiente")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_identificacao_ambiente = :nf_principal_IdentificacaoAmbiente_2937 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_IdentificacaoAmbiente_2937", NpgsqlDbType.Integer, Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "FinalidadeEmissao" || parametro.FieldName == "nfp_finalidade_emissao")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_finalidade_emissao = :nf_principal_FinalidadeEmissao_3392 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_FinalidadeEmissao_3392", NpgsqlDbType.Smallint,  Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "ProcessoEmissao" || parametro.FieldName == "nfp_processo_emissao")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_processo_emissao = :nf_principal_ProcessoEmissao_7025 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_ProcessoEmissao_7025", NpgsqlDbType.Smallint,  Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "VersaoProcessoEmissao" || parametro.FieldName == "nfp_versao_processo_emissao")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_versao_processo_emissao LIKE :nf_principal_VersaoProcessoEmissao_2670 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_VersaoProcessoEmissao_2670", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "TipoEmitente" || parametro.FieldName == "nfp_tipo_emitente")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_tipo_emitente LIKE :nf_principal_TipoEmitente_395 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_TipoEmitente_395", NpgsqlDbType.Char,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Situacao" || parametro.FieldName == "nfp_situacao")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_situacao LIKE :nf_principal_Situacao_6508 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_Situacao_6508", NpgsqlDbType.Char,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Observacoes" || parametro.FieldName == "nfp_observacoes")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_observacoes LIKE :nf_principal_Observacoes_9792 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_Observacoes_9792", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "EntityUid" || parametro.FieldName == "entity_uid")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.entity_uid LIKE :nf_principal_EntityUid_2693 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_EntityUid_2693", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Version" || parametro.FieldName == "version")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.version = :nf_principal_Version_8671 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_Version_8671", NpgsqlDbType.Integer, Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "ObservacoesFisco" || parametro.FieldName == "nfp_observacoes_fisco")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_observacoes_fisco LIKE :nf_principal_ObservacoesFisco_9665 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_ObservacoesFisco_9665", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "EnviarNfeReceita" || parametro.FieldName == "nfp_enviar_nfe_receita")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_enviar_nfe_receita = :nf_principal_EnviarNfeReceita_1586 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_EnviarNfeReceita_1586", NpgsqlDbType.Smallint, Convert.ToInt16(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Homologacao" || parametro.FieldName == "nfp_homologacao")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_homologacao = :nf_principal_Homologacao_2239 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_Homologacao_2239", NpgsqlDbType.Smallint, Convert.ToInt16(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Impressa" || parametro.FieldName == "impressa")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.impressa = :nf_principal_Impressa_3995 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_Impressa_3995", NpgsqlDbType.Smallint, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "EnviarNfseLondrina" || parametro.FieldName == "nfp_enviar_nfse_londrina")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_enviar_nfse_londrina = :nf_principal_EnviarNfseLondrina_2843 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_EnviarNfseLondrina_2843", NpgsqlDbType.Smallint, Convert.ToInt16(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "TributadaEmissor" || parametro.FieldName == "nfp_tributada_emissor")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_tributada_emissor = :nf_principal_TributadaEmissor_202 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_TributadaEmissor_202", NpgsqlDbType.Smallint, Convert.ToInt16(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "BcIssRetido" || parametro.FieldName == "nfp_bc_iss_retido")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_bc_iss_retido = :nf_principal_BcIssRetido_5284 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_BcIssRetido_5284", NpgsqlDbType.Double, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "ValorIssRetido" || parametro.FieldName == "nfp_valor_iss_retido")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_valor_iss_retido = :nf_principal_ValorIssRetido_1911 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_ValorIssRetido_1911", NpgsqlDbType.Double, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "RpsNumero" || parametro.FieldName == "nfp_rps_numero")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_rps_numero = :nf_principal_RpsNumero_5619 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_RpsNumero_5619", NpgsqlDbType.Integer, Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "RpsSerie" || parametro.FieldName == "nfp_rps_serie")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_rps_serie LIKE :nf_principal_RpsSerie_1135 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_RpsSerie_1135", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "RpsData" || parametro.FieldName == "nfp_rps_data")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_rps_data = :nf_principal_RpsData_1994 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_RpsData_1994", NpgsqlDbType.Date, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "ConsumidorFinal" || parametro.FieldName == "nfp_consumidor_final")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_consumidor_final = :nf_principal_ConsumidorFinal_7993 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_ConsumidorFinal_7993", NpgsqlDbType.Smallint, Convert.ToInt16(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "PresencaComprador" || parametro.FieldName == "nfp_presenca_comprador")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_presenca_comprador = :nf_principal_PresencaComprador_6000 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_PresencaComprador_6000", NpgsqlDbType.Smallint,  Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "NfPrincipalSubstituida" || parametro.FieldName == "id_nf_principal_substituida")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.id_nf_principal_substituida = :nf_principal_NfPrincipalSubstituida_4285 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_NfPrincipalSubstituida_4285", NpgsqlDbType.Integer, ((AbstractEntity)parametro.Fieldvalue).ID));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "TextoQrCode" || parametro.FieldName == "nfp_texto_qr_code")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_texto_qr_code LIKE :nf_principal_TextoQrCode_2143 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_TextoQrCode_2143", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "ImpressaoDanfeLiberada" || parametro.FieldName == "nfp_impressao_danfe_liberada")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_impressao_danfe_liberada = :nf_principal_ImpressaoDanfeLiberada_2043 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_ImpressaoDanfeLiberada_2043", NpgsqlDbType.Smallint, Convert.ToInt16(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "ImpressaoDanfeContingencia" || parametro.FieldName == "nfp_impressao_danfe_contingencia")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_impressao_danfe_contingencia = :nf_principal_ImpressaoDanfeContingencia_4149 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_ImpressaoDanfeContingencia_4149", NpgsqlDbType.Smallint, Convert.ToInt16(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "EstoqueMovimentado" || parametro.FieldName == "nfp_estoque_movimentado")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_estoque_movimentado = :nf_principal_EstoqueMovimentado_6420 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_EstoqueMovimentado_6420", NpgsqlDbType.Smallint, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "CMunFgIbs" || parametro.FieldName == "npr_c_mun_fg_ibs")
                     {
                      if (parametro.Fieldvalue != null && (!(parametro.Fieldvalue is string)))
                      {
                         throw new ExcecaoTratada("O parâmetro " + parametro.FieldName + " fornecido não é do tipo string");
                      ...
                      if (parametro.Fieldvalue == null)
                      {
                         whereClause += "  nf_principal.npr_c_mun_fg_ibs IS NULL" ;
                      }
                      else
                      {
                         whereClause += "  nf_principal.npr_c_mun_fg_ibs LIKE :nf_principal_CMunFgIbs_6799 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_CMunFgIbs_6799", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "TpNfDebito" || parametro.FieldName == "npr_tp_nf_debito")
                     {
                      if (parametro.Fieldvalue != null && (!(parametro.Fieldvalue is string)))
                      {
                         throw new ExcecaoTratada("O parâmetro " + parametro.FieldName + " fornecido não é do tipo string");
                      ...
                      if (parametro.Fieldvalue == null)
                      {
                         whereClause += "  nf_principal.npr_tp_nf_debito IS NULL" ;
                      }
                      else
                      {
                         whereClause += "  nf_principal.npr_tp_nf_debito LIKE :nf_principal_TpNfDebito_6232 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_TpNfDebito_6232", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "TpNfCredito" || parametro.FieldName == "npr_tp_nf_credito")
                     {
                      if (parametro.Fieldvalue != null && (!(parametro.Fieldvalue is string)))
                      {
                         throw new ExcecaoTratada("O parâmetro " + parametro.FieldName + " fornecido não é do tipo string");
                      ...
                      if (parametro.Fieldvalue == null)
                      {
                         whereClause += "  nf_principal.npr_tp_nf_credito IS NULL" ;
                      }
                      else
                      {
                         whereClause += "  nf_principal.npr_tp_nf_credito LIKE :nf_principal_TpNfCredito_6055 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_TpNfCredito_6055", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "TpEnteGov" || parametro.FieldName == "npr_tp_ente_gov")
                     {
                      if (parametro.Fieldvalue != null && (!(parametro.Fieldvalue is short?)))
                      {
                         throw new ExcecaoTratada("O parâmetro " + parametro.FieldName + " fornecido não é do tipo short?");
                      ...
                      if (parametro.Fieldvalue == null)
                      {
                         whereClause += "  nf_principal.npr_tp_ente_gov IS NULL" ;
                      }
                      else
                      {
                         whereClause += "  nf_principal.npr_tp_ente_gov = :nf_principal_TpEnteGov_5666 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_TpEnteGov_5666", NpgsqlDbType.Smallint, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "PRedutor" || parametro.FieldName == "npr_p_redutor")
                     {
                      if (parametro.Fieldvalue != null && (!(parametro.Fieldvalue is double?)))
                      {
                         throw new ExcecaoTratada("O parâmetro " + parametro.FieldName + " fornecido não é do tipo double?");
                      ...
                      if (parametro.Fieldvalue == null)
                      {
                         whereClause += "  nf_principal.npr_p_redutor IS NULL" ;
                      }
                      else
                      {
                         whereClause += "  nf_principal.npr_p_redutor = :nf_principal_PRedutor_3308 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_PRedutor_3308", NpgsqlDbType.Double, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "TpOperGov" || parametro.FieldName == "npr_tp_oper_gov")
                     {
                      if (parametro.Fieldvalue != null && (!(parametro.Fieldvalue is short?)))
                      {
                         throw new ExcecaoTratada("O parâmetro " + parametro.FieldName + " fornecido não é do tipo short?");
                      ...
                      if (parametro.Fieldvalue == null)
                      {
                         whereClause += "  nf_principal.npr_tp_oper_gov IS NULL" ;
                      }
                      else
                      {
                         whereClause += "  nf_principal.npr_tp_oper_gov = :nf_principal_TpOperGov_7136 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_TpOperGov_7136", NpgsqlDbType.Smallint, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "NaturezaOperacaoExato" || parametro.FieldName == "NaturezaOperacaoExata")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_natureza_operacao LIKE :nf_principal_NaturezaOperacao_2416 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_NaturezaOperacao_2416", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "ModeloDocFiscalExato" || parametro.FieldName == "ModeloDocFiscalExata")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_modelo_doc_fiscal LIKE :nf_principal_ModeloDocFiscal_2446 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_ModeloDocFiscal_2446", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "VersaoProcessoEmissaoExato" || parametro.FieldName == "VersaoProcessoEmissaoExata")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_versao_processo_emissao LIKE :nf_principal_VersaoProcessoEmissao_533 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_VersaoProcessoEmissao_533", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "TipoEmitenteExato" || parametro.FieldName == "TipoEmitenteExata")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_tipo_emitente LIKE :nf_principal_TipoEmitente_1818 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_TipoEmitente_1818", NpgsqlDbType.Char,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "SituacaoExato" || parametro.FieldName == "SituacaoExata")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_situacao LIKE :nf_principal_Situacao_9230 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_Situacao_9230", NpgsqlDbType.Char,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "ObservacoesExato" || parametro.FieldName == "ObservacoesExata")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_observacoes LIKE :nf_principal_Observacoes_2953 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_Observacoes_2953", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "EntityUidExato" || parametro.FieldName == "EntityUidExata")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.entity_uid LIKE :nf_principal_EntityUid_1641 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_EntityUid_1641", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "ObservacoesFiscoExato" || parametro.FieldName == "ObservacoesFiscoExata")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_observacoes_fisco LIKE :nf_principal_ObservacoesFisco_4566 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_ObservacoesFisco_4566", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "RpsSerieExato" || parametro.FieldName == "RpsSerieExata")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_rps_serie LIKE :nf_principal_RpsSerie_5604 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_RpsSerie_5604", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "TextoQrCodeExato" || parametro.FieldName == "TextoQrCodeExata")
                     {
                      ...
                      {
                         whereClause += "  nf_principal.nfp_texto_qr_code LIKE :nf_principal_TextoQrCode_1200 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_TextoQrCode_1200", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "CMunFgIbsExato" || parametro.FieldName == "CMunFgIbsExata")
                     {
                      if (parametro.Fieldvalue != null && (!(parametro.Fieldvalue is string)))
                      {
                         throw new ExcecaoTratada("O parâmetro " + parametro.FieldName + " fornecido não é do tipo string");
                      ...
                      {
                         whereClause += "  nf_principal.npr_c_mun_fg_ibs LIKE :nf_principal_CMunFgIbs_8643 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_CMunFgIbs_8643", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "TpNfDebitoExato" || parametro.FieldName == "TpNfDebitoExata")
                     {
                      if (parametro.Fieldvalue != null && (!(parametro.Fieldvalue is string)))
                      {
                         throw new ExcecaoTratada("O parâmetro " + parametro.FieldName + " fornecido não é do tipo string");
                      ...
                      {
                         whereClause += "  nf_principal.npr_tp_nf_debito LIKE :nf_principal_TpNfDebito_592 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_TpNfDebito_592", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "TpNfCreditoExato" || parametro.FieldName == "TpNfCreditoExata")
                     {
                      if (parametro.Fieldvalue != null && (!(parametro.Fieldvalue is string)))
                      {
                         throw new ExcecaoTratada("O parâmetro " + parametro.FieldName + " fornecido não é do tipo string");
                      ...
                      {
                         whereClause += "  nf_principal.npr_tp_nf_credito LIKE :nf_principal_TpNfCredito_1945 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_principal_TpNfCredito_1945", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
...
if (!operacao.HasValue)
{
    operacao = Guid.NewGuid();
                  ...
                  if (entidade == null)
                  {
                     ...
                     entidade.CMunFgIbs = (read["npr_c_mun_fg_ibs"] != DBNull.Value ? read["npr_c_mun_fg_ibs"].ToString() : null);
                     entidade.TpNfDebito = (read["npr_tp_nf_debito"] != DBNull.Value ? read["npr_tp_nf_debito"].ToString() : null);
                     entidade.TpNfCredito = (read["npr_tp_nf_credito"] != DBNull.Value ? read["npr_tp_nf_credito"].ToString() : null);
                     entidade.TpEnteGov = read["npr_tp_ente_gov"] as short?;
                     entidade.PRedutor = read["npr_p_redutor"] as double?;
                     entidade.TpOperGov = read["npr_tp_oper_gov"] as short?;
