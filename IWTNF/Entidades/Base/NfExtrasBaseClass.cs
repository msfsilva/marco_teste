               ...
               foreach (SearchParameterClass parametro in parametros) 
               {
                  ...
                  else
                  {
                     ...
                     if (parametro.FieldName == "ID" || parametro.FieldName == "id_nf_extras")
                     {
                      ...
                      {
                         whereClause += "  nf_extras.id_nf_extras = :nf_extras_ID_6465 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_extras_ID_6465", NpgsqlDbType.Bigint, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Texto" || parametro.FieldName == "nfx_texto")
                     {
                      ...
                      {
                         whereClause += "  nf_extras.nfx_texto LIKE :nf_extras_Texto_1037 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_extras_Texto_1037", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "NfPrincipal" || parametro.FieldName == "id_nf_principal")
                     {
                      ...
                      {
                         whereClause += "  nf_extras.id_nf_principal = :nf_extras_NfPrincipal_9438 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_extras_NfPrincipal_9438", NpgsqlDbType.Integer, ((AbstractEntity)parametro.Fieldvalue).ID));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "TextoV2" || parametro.FieldName == "nfx_texto_v2")
                     {
                      ...
                      {
                         whereClause += "  nf_extras.nfx_texto_v2 LIKE :nf_extras_TextoV2_6935 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_extras_TextoV2_6935", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "EntityUid" || parametro.FieldName == "entity_uid")
                     {
                      ...
                      {
                         whereClause += "  nf_extras.entity_uid LIKE :nf_extras_EntityUid_4094 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_extras_EntityUid_4094", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Version" || parametro.FieldName == "version")
                     {
                      ...
                      {
                         whereClause += "  nf_extras.version = :nf_extras_Version_9347 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_extras_Version_9347", NpgsqlDbType.Integer, Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "TextoExato" || parametro.FieldName == "TextoExata")
                     {
                      ...
                      {
                         whereClause += "  nf_extras.nfx_texto LIKE :nf_extras_Texto_4686 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_extras_Texto_4686", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "TextoV2Exato" || parametro.FieldName == "TextoV2Exata")
                     {
                      ...
                      {
                         whereClause += "  nf_extras.nfx_texto_v2 LIKE :nf_extras_TextoV2_2401 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_extras_TextoV2_2401", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "EntityUidExato" || parametro.FieldName == "EntityUidExata")
                     {
                      ...
                      {
                         whereClause += "  nf_extras.entity_uid LIKE :nf_extras_EntityUid_5758 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_extras_EntityUid_5758", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
