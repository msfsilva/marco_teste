               ...
               foreach (SearchParameterClass parametro in parametros) 
               {
                  ...
                  else
                  {
                     ...
                     if (parametro.FieldName == "NfItem" || parametro.FieldName == "id_nf_item")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_pis.id_nf_item = :nf_produto_pis_NfItem_5768 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_pis_NfItem_5768", NpgsqlDbType.Integer, ((AbstractEntity)parametro.Fieldvalue).ID));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Cst" || parametro.FieldName == "npp_cst")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_pis.npp_cst LIKE :nf_produto_pis_Cst_2024 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_pis_Cst_2024", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Aliquota" || parametro.FieldName == "npp_aliquota")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_pis.npp_aliquota = :nf_produto_pis_Aliquota_8055 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_pis_Aliquota_8055", NpgsqlDbType.Double, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "ModadlidadeTributacao" || parametro.FieldName == "npp_modadlidade_tributacao")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_pis.npp_modadlidade_tributacao = :nf_produto_pis_ModadlidadeTributacao_2452 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_pis_ModadlidadeTributacao_2452", NpgsqlDbType.Smallint,  Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "ImpostoRetido" || parametro.FieldName == "npp_imposto_retido")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_pis.npp_imposto_retido = :nf_produto_pis_ImpostoRetido_5998 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_pis_ImpostoRetido_5998", NpgsqlDbType.Smallint, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "EntityUid" || parametro.FieldName == "entity_uid")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_pis.entity_uid LIKE :nf_produto_pis_EntityUid_8484 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_pis_EntityUid_8484", NpgsqlDbType.Varchar,"%"+ parametro.Fieldvalue+"%"));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "Version" || parametro.FieldName == "version")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_pis.version = :nf_produto_pis_Version_8347 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_pis_Version_8347", NpgsqlDbType.Integer, Convert.ToInt32(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "ID" || parametro.FieldName == "id_nf_produto_pis")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_pis.id_nf_produto_pis = :nf_produto_pis_ID_1362 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_pis_ID_1362", NpgsqlDbType.Bigint, parametro.Fieldvalue));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "CompoeTotal" || parametro.FieldName == "npp_compoe_total")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_pis.npp_compoe_total = :nf_produto_pis_CompoeTotal_3931 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_pis_CompoeTotal_3931", NpgsqlDbType.Smallint, Convert.ToInt16(parametro.Fieldvalue)));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "CstExato" || parametro.FieldName == "CstExata")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_pis.npp_cst LIKE :nf_produto_pis_Cst_260 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_pis_Cst_260", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
                     if (parametro.FieldName == "EntityUidExato" || parametro.FieldName == "EntityUidExata")
                     {
                      ...
                      {
                         whereClause += "  nf_produto_pis.entity_uid LIKE :nf_produto_pis_EntityUid_3630 " ;
                         command.Parameters.Add(new IWTPostgreNpgsqlCommandParameter("nf_produto_pis_EntityUid_3630", NpgsqlDbType.Varchar,""+ parametro.Fieldvalue+""));
                      }
                      whereClause += " ) " ;
                        continue;
                     }
